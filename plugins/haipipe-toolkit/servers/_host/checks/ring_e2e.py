...
HOST = Path(__file__).resolve().parent.parent   # servers/_host
SKILL = HOST.parents[1] / "skills" / "board" / "haipipe-board"   # cli/build.py, the fixture
CLI = SKILL / "cli"
...
def main():
    ...
    srv = subprocess.Popen(
        [sys.executable, str(HOST / "serve.py"), "--root", str(root),
