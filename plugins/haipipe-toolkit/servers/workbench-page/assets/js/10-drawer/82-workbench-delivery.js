 ...
 * live segmented surface is servers/workbench-page/delivery.py (/_board/delivery), whose
 ...
 * replaced 82-workbench-exports.js (git mv, 260831): the separate 📜 LaTeX and
 * 📝 Word rows folded in here the way 📚 bibex folded into 🧾 Evidence.
 *
 * Uses the standard workbench tab spec: register with {tab: {url, write}}
 * and the shell builds the right-pane tab — workbench N+1 ships by registering.
 */
(function () {
  'use strict';
