/* 📃 Page · the page re-read per division, the rail's FIRST surface.
 *
 ...
 *
 * FIRST by explicit Workbench order. Outline presents three minimal workspaces:
...
(function () {
  ...
  document.addEventListener('click', function (event) {
    ...
    var page = link.closest('section.slide.q')
            || (window.boardWorkbenches && window.boardWorkbenches.livePage());
