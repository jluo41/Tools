    ...
    add('✅ Quality Check', function () {
      var prompt = isBoard
        ...
        : 'QUALITY CHECK — answer only. Do not modify any file or run commands. ' +
          ...
          'Tools/plugins/haipipe-toolkit/skills/page/haipipe-page/SKILL.md and the cold-read rules at ' +
  ...
  async function chatOpen(sec) {
    ...
    /* REOPENING THE SAME CHAT IS NOT A REASON TO REBUILD IT (JL 260801: "我把
       它打开、关了、又打开，它就没有那么丝滑了 ... VS Code 的 workbench 无论什么
       时候开它都是非常丝滑的").
  ...
  /* KEEP = the page's sessions land in its chat/ workbench (QPf4, JL 260815:
