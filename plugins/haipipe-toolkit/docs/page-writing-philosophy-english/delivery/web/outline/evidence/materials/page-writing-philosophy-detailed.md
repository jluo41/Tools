...
![A narrow request should not silently undo earlier decisions.](assets/page-writing-illustrations/v1/detailed/01-small-edit.png)
...
![A candidate draft helps the author discover and refine the intended point.](assets/page-writing-illustrations/v1/detailed/02-discover-through-drafting.png)
...
![Keep the exact feedback attached to the exact text, alongside the resulting change.](assets/page-writing-illustrations/v1/detailed/04-keep-feedback.png)
...
![Change the requested span; keep settled surrounding text intact.](assets/page-writing-illustrations/v1/detailed/05-edit-within-scope.png)
...
![A Run contains Steps that preserve the exchange and let us resume.](assets/page-writing-illustrations/v1/detailed/06-run-and-steps.png)
...
![Save and return the small revision promptly; longer tasks can proceed separately.](assets/page-writing-illustrations/v1/detailed/07-fast-revisions.png)
...
![Missing support stays visible; contradictory evidence returns the claim for discussion.](assets/page-writing-illustrations/v1/detailed/08-evidence-and-claims.png)
...
![Learn preferences from repeated examples while keeping context-specific comments local.](assets/page-writing-illustrations/v1/detailed/09-learn-from-feedback.png)
...
![Resume on another device with the paragraph and its decisions intact.](assets/page-writing-illustrations/v1/detailed/10-writing-everywhere.png)
