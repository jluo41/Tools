...
| `input_preservation` · Input preservation | **pass** | informational | The imported editable copy matches `37c49672fc9f1bf52e9925d6756b433d8d637ff34c4b25debb0b70a06f289073`. External original was not available during this Folder resume. |
...
| `bullet_head_readability` · Bullet-head readability | **missing** | blocking | One or more Bullet heads are clipped, outside the 4–11 word planning range, or written as planner instructions. |
