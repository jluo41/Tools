# workers/REF : paper folder anatomy
...
The companion doc `workers/REF/tex-file-anatomy.md` defines the anatomy of
...
- The filename is the structural address. See
  `workers/REF/tex-file-anatomy.md` for what goes inside each file role.
