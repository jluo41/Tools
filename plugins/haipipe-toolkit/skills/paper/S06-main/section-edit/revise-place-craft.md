...
Craft file for stage section-edit, loaded by the REVISE phase (it runs FIRST in the revise chain, before content, humanizer, and results work).
Source: converted from `workers/haipipe-paper-revise-place/SKILL.md` on 2026-08-05 (thin-paper phase 2); it is DATA, not a registered skill.

> **Where this grammar was ruled.** This craft implements three rulings on the
...
> why this pass may place a key and may never write one), `QC2@paper` the value
