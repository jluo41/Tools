---
name: haipipe-paper-structure-illustration-image2
...
metadata:
  ...
  changelog:
    - "1.1.0 (2026-06-05): renamed from paper-illustration-image2 to haipipe-paper-structure-illustration-image2 (haipipe-paper-* name unification)."
...
**Not for:** Statistical plots (use `/haipipe-paper-structure-figure`), deterministic vector topology figures (prefer `/haipipe-paper-structure-figure-spec`), photo-realistic scenes
