...
```bash
/haipipe-paper-structure-architecture @paper-structure.md @slides-with-results.pdf
...
```
/haipipe-paper-structure-architecture @abstract.md
...
```
/haipipe-paper-structure-architecture @paper-draft.md
```
...
```
.claude/skills/haipipe-paper-structure-architecture/
...
**Workflow:** `/paper-structure-planning` → `/haipipe-paper-structure-architecture` → Write paper
