# /haipipe-paper-structure-incubator
...
```
/haipipe-paper-structure-incubator display      Catalog every figure/table with deep analysis
/haipipe-paper-structure-incubator arch          Paper architecture: summary, contributions, story arc, scope
/haipipe-paper-structure-incubator structure     Section-by-section paragraph blueprint with display placement
```

## How It Works

1. Invoke a command (e.g., `/haipipe-paper-structure-incubator arch`)
