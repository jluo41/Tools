...
- `clinical-medicine-playbook` when the target is a CLINICAL medical journal (JAMA, JAMA Internal Medicine, NEJM, The Lancet, Annals of Internal Medicine, BMJ); do NOT default to the Nature-style basic-science framing for clinical venues, and treat a method already published elsewhere as an enabler rather than the contribution
