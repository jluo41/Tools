...
| External gate layer | `9 Review`, `10 Submit`, `11 Respond`, `12 Present` | How the paper survives audiences outside the author loop | review reports, `1-rounds/`, rebuttal drafts, submission bundles, slides/posters |
...
| 11. Respond / Revise | Convert reviews into revision plan and response | `haipipe-paper-rebuttal`, `paper-rebuttal`, `rebuttal-response` | reviewer comments, submitted manuscript, pitch/narrative | `lifecycle/stage11_respond-revise/current.md`, `1-rounds/`, response letter, revised sections | Which layer did reviewers actually challenge? |
...
Do not create `0-sections/`, `0-displays/`, LaTeX wrappers, or compile scripts
...
- `0-displays/` changes when visual evidence changes.
- `1-rounds/` changes when external comments, rebuttal, or revision process
  artifacts arrive.
