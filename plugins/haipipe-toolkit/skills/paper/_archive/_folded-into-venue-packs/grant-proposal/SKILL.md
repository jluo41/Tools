...
- Uses `/haipipe-paper-display-illustration-gemini` for figure generation (if user requests)
...
For AI-generated publication-quality figures, invoke `/haipipe-paper-display-illustration-gemini`:

```
/haipipe-paper-display-illustration-gemini "Overview diagram showing [aims relationship + shared resources] for grant proposal"
```
...
| `/haipipe-paper-display-illustration-gemini` | 3 | Generate proposal figures (optional) |
