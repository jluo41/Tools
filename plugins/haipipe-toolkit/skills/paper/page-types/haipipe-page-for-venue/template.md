<!-- TEMPLATE · ONE SUBMISSION TARGET = ONE QBv PAGE.
     ...
     `haipipe-page-for-venue/SKILL.md` (this Page Type) or in `haipipe-page`
...
themselves live in `haipipe-page-for-venue`, which this page instantiates.>
...
from `haipipe-page` and `QB4-overall.md`, and are not restated here.
...
- `<path>/board/page-types/haipipe-page-for-venue/SKILL.md`
...
- `<path>/board/haipipe-page/SKILL.md`
