...
<!-- RULE: E0 COMES FIRST, matching its number and the core contract's own listing. It is the
     standing collect queue: a Q-consumer born on ANY page lands here first and waits until EVIDENCE
...
<!-- RULE: A CONSUMER ROW CARRIES A CLAIM DEPENDENCY, never a chore and never an ordered answer.
     ...
     learns which claim would be rescued; `page-workflows/haipipe-page-evidence` owns that wall. -->
...
- `reads · EVIDENCE` · [<consumer page id>](<path/to/consumer-page.md>)
