haipipe-page-for-dash-literature · Changelog
============================================
...
The Literature Dash now inventories the candidate Literature Display card paired with every
probe, as well as the gap map. A card may be `candidate`, `parked`, or `not-displayable`;
Narrative selection and the formal Paper Display unit remain separate steps.

## 0.1.0 - 2026-08-09

First cut of the LITERATURE dash, on JL's 260809 ruling that each multi-unit paper family gets
a dash and every dash reads the venue structure.

- Carries the gap contract, which belongs to the whole concern and to no single topic, plus the topic map and the coverage check against the desk's expectation.
