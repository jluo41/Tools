...
### 2 · Ideas (ranked)               🔥 summary table, one row per live idea
                                        · one source bullet per ideation handoff
                                          or legacy IDEA_REPORT drawn from
...
```text
claim · search question · closest verified work · remaining delta · limitation · status · QA path
```
...
card or a discovery-/task-layer QA file, never by direct write.
