---
name: haipipe-paper-structure-incubator
...
metadata:
  ...
  changelog:
    - "1.1.0 (2026-06-05): renamed from paper-incubator to haipipe-paper-structure-incubator (haipipe-paper-* name unification)."
    - "1.0.0 (2026-05-31): baseline metadata added."
---

Skill: haipipe-paper-structure-incubator
======================
...
```
/haipipe-paper-structure-incubator display   →  00-incubator-display.tex
/haipipe-paper-structure-incubator arch      →  01-incubator-arch.tex
/haipipe-paper-structure-incubator structure →  02-incubator-structure.tex
```
...
```
.claude/skills/haipipe-paper-structure-incubator/
  SKILL.md                    ← you are here (router + protocol)
  arch.md                     ← /haipipe-paper-structure-incubator arch rules
  display.md                  ← /haipipe-paper-structure-incubator display rules
  structure.md                ← /haipipe-paper-structure-incubator structure rules
  templates/
