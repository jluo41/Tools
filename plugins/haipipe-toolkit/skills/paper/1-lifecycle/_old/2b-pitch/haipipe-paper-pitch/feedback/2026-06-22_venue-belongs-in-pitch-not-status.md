...
status: fixed
created: 2026-06-22
context: where "venue" lives in the lifecycle; affects haipipe-paper-pitch rubric + lifecycle-map.md / paper-dashboard.md (venue placement) + haipipe-paper-enter (STATUS frontmatter)
fixed_in: "haipipe-paper-pitch v1.1.0"
---
...
- haipipe-paper-pitch: add "Audience / Venue Fit" to the seven-part template (between So-What and Why-Believe, or folded into So-What) and to its done-rubric.
