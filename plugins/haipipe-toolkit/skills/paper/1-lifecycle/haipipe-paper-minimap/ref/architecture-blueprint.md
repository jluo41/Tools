# Reference: Paper Architecture Blueprint

> Merged into `haipipe-paper-minimap` (2026-06-22) from the retired
> `haipipe-paper-architecture` skill. Reference material for the minimap
> stage: the 5-act arc, contribution emphasis, main-vs-appendix split, page budget,
> language guide, and the cue-word -> strategic-constraint detection table. Worked
> examples live in `architecture-examples/`. Not a standalone skill.
---
...
through `/haipipe-paper-lifecycle pitch` and log the reason.
