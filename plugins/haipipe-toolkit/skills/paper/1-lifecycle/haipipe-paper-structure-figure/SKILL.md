---
name: haipipe-paper-structure-figure
...
metadata:
  ...
  changelog:
    - "1.1.0 (2026-06-05): renamed from paper-figure to haipipe-paper-structure-figure (haipipe-paper-* name unification)."
...
1. **PAPER_PLAN.md** — figure plan table (from `/haipipe-paper-structure-plan`)
