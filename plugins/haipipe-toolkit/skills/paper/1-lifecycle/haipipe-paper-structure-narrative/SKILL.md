---
name: haipipe-paper-structure-narrative
...
metadata:
  ...
  changelog:
    - "1.1.0 (2026-06-05): renamed from narrative-report to haipipe-paper-structure-narrative (haipipe-paper-* name unification)."
...
- Before invoking `/haipipe-paper` or `/haipipe-paper-structure-plan` (they consume this file)
...
/idea-discovery   ──► IDEA_REPORT ─┐
                                   ├──► /haipipe-paper-structure-narrative  ──► NARRATIVE_REPORT.md ──► /haipipe-paper
implement + experiments            │                                                       │
                                   │                                                       ├──► /haipipe-paper-structure-plan
/auto-review-loop ──► AUTO_REVIEW ─┤                                                       ├──► /haipipe-paper-structure-figure
                                   │                                                       ├──► /haipipe-paper-edit-write
