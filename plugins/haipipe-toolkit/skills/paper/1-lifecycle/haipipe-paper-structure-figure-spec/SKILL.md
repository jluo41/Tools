---
name: haipipe-paper-structure-figure-spec
...
metadata:
  ...
  changelog:
    - "1.1.0 (2026-06-05): renamed from figure-spec to haipipe-paper-structure-figure-spec (haipipe-paper-* name unification)."
...
**Use `haipipe-paper-structure-figure-spec`** for:
...
**Do NOT use for:**
- Data plots (bar/line/scatter) — use `/haipipe-paper-structure-figure`
- Natural/qualitative illustrations — use `/haipipe-paper-structure-illustration`
...
- **`/haipipe-paper-structure-figure`**: handles data plots; they complement each other (data + architecture = complete figure set)
- **`/haipipe-paper-structure-illustration`**: fallback for figures that need natural/qualitative style (method illustrations with photos, qualitative result grids)
