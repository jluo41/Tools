...
%
% The pitch is venue-ALIGNED = cover letter.
% RQs live here (venue-coupled). Claims holds venue-neutral hypotheses
% (H1, H2, H3); pitch reframes them as venue-specific RQs for the target editor.
%
...
\usepackage{tabularx}
\usepackage{hyperref}
\title{Pitch / Cover Letter: <Paper Title> (<Venue>)}
\date{YYYY-MM-DD}
\begin{document}
\maketitle
...
% =========================================================
% Para [pitch.editor] Editor's Chair -- will the editor publish this?
% Cue: read _venue/playbook-<venue> for the editor's chair question.
%       Every primary claim must have a one-sentence answer.
%       Migrated from claims (v3.0.0): this is a venue question, not evidence.
% =========================================================
%% ---- P5.S1 ----
...
\section*{Primary Claim + RQ Framing}
% =========================================================
% Para [pitch.rq] Primary claim and venue-specific RQ framing
% Cue: read claims (venue-neutral H1, H2, H3), designate ONE primary for
%       THIS venue, reframe hypotheses as venue-specific RQs.
%       A venue change re-runs this section.
% =========================================================
%% ---- P6.S1 ----
\textbf{Primary claim for <Venue>:} C<N> -- <claim>. This is primary because <what the venue rewards>.
%
%% ---- P6.S2 ----
Other claims (C<M>, C<K>) are supporting.

\bigskip

% H→RQ mapping: how venue-neutral hypotheses become venue-specific RQs.
\begin{small}
\begin{tabularx}{\textwidth}{@{}p{0.04\textwidth}p{0.04\textwidth}X p{0.28\textwidth}@{}}
\toprule
...
%       This section is venue-ALIGNED (the pitch is the cover letter).
% =========================================================
%% ---- P7.S1 ----
