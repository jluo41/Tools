...
status: fixed
created: 2026-06-22
context: pitch stage. Responsible skills: haipipe-paper-pitch (canonical pitch structure) and the scaffolded 1-pitch.tex stub emitted by haipipe-paper-folder / scripts/init_paper_layout.py (pitch_tex).
fixed_in: "2026-06-22 revision pass (init_paper_layout.py pitch_tex + haipipe-paper-pitch template)"
---
...
Detail: the canonical pitch skill (haipipe-paper-pitch) does carry
