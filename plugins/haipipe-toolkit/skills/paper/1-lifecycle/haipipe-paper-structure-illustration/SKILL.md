---
name: haipipe-paper-structure-illustration
...
metadata:
  ...
  changelog:
    - "1.1.0 (2026-06-05): renamed from paper-illustration to haipipe-paper-structure-illustration (haipipe-paper-* name unification)."
...
Sources accepted: local TeX dir / file, local PDF, arXiv id, http(s) URL. Overleaf URLs/IDs are rejected — clone via `/haipipe-paper-edit-to-overleaf setup <id>` first and pass the local clone path.
...
**Not for:** Statistical plots (use `/haipipe-paper-structure-figure`), photo-realistic images
