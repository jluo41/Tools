...
Remove AI-writing patterns from academic prose while preserving scholarly precision and voice. This is a POLISH worker that runs alongside `edit-content` (what sentences say) and `edit-weaving` (paragraph flow). This skill reviews HOW sentences sound.
...
Path: `../../../../references/academic-humanizer/SKILL.md` (from this skill's location: `2-section-edit/polish/haipipe-paper-section-edit-humanizer/`)
