---
name: haipipe-paper-section-edit-write-systems
...
metadata:
  ...
  changelog:
    - "1.1.0 (2026-06-05): renamed from writing-systems-papers to haipipe-paper-section-edit-write-systems (haipipe-paper-* name unification)."
...
13. Hand off to /haipipe-paper-section-edit-write for LaTeX generation and citation verification
```
...
- [ ] All citations verified (delegate to /haipipe-paper-section-edit-write)
...
- Never generate citations from memory — use /haipipe-paper-section-edit-write citation workflow
