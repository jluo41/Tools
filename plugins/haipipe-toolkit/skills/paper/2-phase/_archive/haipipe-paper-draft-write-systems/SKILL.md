---
name: haipipe-paper-draft-write-systems
...
metadata:
  ...
  changelog:
    - "1.1.0 (2026-06-05): renamed from writing-systems-papers to haipipe-paper-draft-write-systems (haipipe-paper-* name unification)."
...
13. Hand off to /haipipe-paper-draft for LaTeX generation and citation verification
```
...
- [ ] All citations verified (delegate to /haipipe-paper-draft)
...
- Never generate citations from memory — use /haipipe-paper-draft citation workflow
