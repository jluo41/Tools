---
name: haipipe-paper-section-edit-proof-checker
...
metadata:
  ...
  changelog:
    - "1.1.0 (2026-06-05): renamed from proof-checker to haipipe-paper-section-edit-proof-checker; consolidated into 2-section-edit/ (haipipe-paper-* name unification)."
...
```json
{
  "audit_skill":      "haipipe-paper-section-edit-proof-checker",
  ...
  "trace_path":       ".aris/traces/haipipe-paper-section-edit-proof-checker/<date>_run<NN>/",
...
Every invocation uses a fresh `mcp__codex__codex` thread. Never `codex-reply` across haipipe-paper-section-edit-proof-checker runs. Do not accept prior audit outputs (PAPER_CLAIM_AUDIT, CITATION_AUDIT, EXPERIMENT_LOG) as input — the fresh thread preserves reviewer independence per `shared-references/reviewer-independence.md`.
...
```
/haipipe-paper-section-edit-proof-checker "neurips_2025.tex"
/haipipe-paper-section-edit-proof-checker "check the GMM generalization proof, focus on dimension dependence"
/haipipe-paper-section-edit-proof-checker "verify proof in paper.tex — difficulty: nightmare"
```
