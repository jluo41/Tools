Pattern catalog — vendored copy (haipipe-paper-revise-humanizer)
==================================================================

Vendored 2026-07-07 from AIScientists-Dev/academic-humanizer @ 02281d8 (MIT).
JL rule: skills are self-contained — a SKILL never depends on references/
content at runtime; references/ submodules are archival source only.
To refresh: re-copy from the submodule and update this header's commit hash.
