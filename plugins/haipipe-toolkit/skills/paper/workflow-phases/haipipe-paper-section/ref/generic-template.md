...
structure-source: ref/generic-template.md
structure-division: <why: ABSENT BY DESIGN or MISSING>
evidence-items:
  - <E01-VALUE-readable-name>
  - <E02-CITE-readable-name>
  - <E03-DISPLAY-readable-name>
transition-in: <join from the prior Section Narrative row>
transition-out: <join to the next Section Narrative row>
```
...
Create only the moves required by the current Story Section Narrative row. For each move:
...
- Every move traces to the current Story Section Narrative row.
