---
name: haipipe-paper-edit-claim-audit
...
metadata:
  ...
  changelog:
    - "1.1.0 (2026-06-05): renamed from paper-claim-audit to haipipe-paper-edit-claim-audit; consolidated into 3-edit/ (haipipe-paper-* name unification)."
...
| **`/haipipe-paper-edit-claim-audit`** | **Does the paper report the data truthfully and precisely?** |
...
1. **After `/haipipe-paper-edit-write`** — first check before improvement loop
2. **After `/haipipe-paper-edit-improve-loop`** — recheck if improvement loop changed numbers
3. **Before submission** — final verification

## Integration with Other Skills

### Read by `/haipipe-paper-edit-improve-loop` (if exists)
...
```json
{
  "audit_skill":      "haipipe-paper-edit-claim-audit",
  ...
  "trace_path":       ".aris/traces/haipipe-paper-edit-claim-audit/<date>_run<NN>/",
