...
metadata:
  ...
  changelog:
    - "1.1.0 (2026-06-05): renamed from proof-checker to haipipe-paper-section-edit-proof-checker; consolidated into 3-write-edit/ (haipipe-paper-* name unification)."
...
`codex-reply` across haipipe-paper-section-edit-proof-checker runs. Do not accept prior audit outputs
