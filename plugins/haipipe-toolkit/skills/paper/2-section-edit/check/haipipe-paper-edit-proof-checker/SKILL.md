---
name: haipipe-paper-edit-proof-checker
...
metadata:
  ...
  changelog:
    - "1.1.0 (2026-06-05): renamed from proof-checker to haipipe-paper-edit-proof-checker; consolidated into 3-write-edit/ (haipipe-paper-* name unification)."
...
```json
{
  "audit_skill":      "haipipe-paper-edit-proof-checker",
  ...
  "trace_path":       ".aris/traces/haipipe-paper-edit-proof-checker/<date>_run<NN>/",
...
`codex-reply` across haipipe-paper-edit-proof-checker runs. Do not accept prior audit outputs
...
```
/haipipe-paper-edit-proof-checker "neurips_2025.tex"
/haipipe-paper-edit-proof-checker "check the GMM generalization proof, focus on dimension dependence"
/haipipe-paper-edit-proof-checker "verify proof in paper.tex — difficulty: nightmare"
```
