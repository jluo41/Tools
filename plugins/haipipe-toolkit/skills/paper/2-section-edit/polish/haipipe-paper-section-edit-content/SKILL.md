...
numbers or citations against their sources (that is `haipipe-paper-section-edit-values` and
`haipipe-paper-section-edit-citation`) — but it **does flag** a missing number or citation so
