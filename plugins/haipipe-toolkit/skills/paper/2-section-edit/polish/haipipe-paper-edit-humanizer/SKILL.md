...
# haipipe-paper-edit-humanizer

Remove AI-writing patterns from academic prose while preserving scholarly
precision and voice. This is a L7 POLISH worker that runs alongside
...
(from this skill's location: `2-section-edit/polish/haipipe-paper-edit-humanizer/`)
