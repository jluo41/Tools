...
- haipipe-paper-structure-claims template = matrix table + a "Per-claim detail" section with one banner+paragraph per claim ([claims.c1], [claims.c2], ...), each in the %% ---- Pn.Sm ---- sentence format.
