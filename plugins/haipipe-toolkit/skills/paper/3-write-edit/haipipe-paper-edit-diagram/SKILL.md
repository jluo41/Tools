---
name: haipipe-paper-edit-diagram
...
metadata:
  ...
  changelog:
    - "1.1.0 (2026-06-05): renamed from paper-structure-diagram to haipipe-paper-edit-diagram (haipipe-paper-* name unification)."
    - "1.0.0 (2026-05-31): baseline metadata added."
---

# /haipipe-paper-edit-diagram — Section / Paragraph / Sentence Maps
...
```
/haipipe-paper-edit-diagram                              section view of paper at cwd
/haipipe-paper-edit-diagram sections [path]              section view (whole paper)
/haipipe-paper-edit-diagram paragraphs <sec> [path]      paragraph view of one section
/haipipe-paper-edit-diagram sentences <sec> <par> [path] sentence view of one paragraph
/haipipe-paper-edit-diagram all [path]                   all three for whole paper
```
...
Compatible with both `haipipe-paper-bootstrap` layout and the user's `0-` prefix convention:
...
7. **Append** a one-line "next action" hint when something is flagged:
   ...
   - `→ §1 ¶3 has no [claim]. Run /haipipe-paper-edit-diagram sentences 1 3 to inspect.`

---

## Cross-references

- `haipipe-paper-bootstrap` (`05_prewrite/`) — initial folder layout this skill reads.
