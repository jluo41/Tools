<!-- TEMPLATE (follow, don't ship). Fill 0-lifecycle/S02-work/1b-claims.md from this skeleton: replace every <…>, and each `<!-- RULE: … -->` comment is guidance to FOLLOW then DELETE — a RULE comment never appears in the finished doc. Delete this top line too. -->
...
Q-consumer
----------
<!-- RULE: logical source for Board `## Aims`: each evidence question becomes one
...
- P<m> · Q-Claim-<m> · <question title — e.g. metformin placebo null (placebo)>
  **Done when:** The answer has landed, been interpreted, and been woven into Content.
