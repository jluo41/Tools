<!-- TEMPLATE (follow, don't ship). Fill 0-lifecycle/S01-opening/S-Venue-0-venue.md from this skeleton: replace every <…>, and each `<!-- RULE: … -->` comment is guidance to FOLLOW then DELETE. Delete this top line too. -->
