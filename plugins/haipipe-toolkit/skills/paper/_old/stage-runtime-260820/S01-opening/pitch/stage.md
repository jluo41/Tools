...
artifact: 0-lifecycle/S01-opening/S-Open-Pitch.md
artifact_fallback: 0-lifecycle/S01-opening/2b-pitch.md
...
closed_when: "EVIDENCE writes the finding + [source: <nested-entry>] into Answer; REVISE weaves it back in
...
Before a word is drafted, read `0-lifecycle/S01-opening/S-Venue-0-venue.md` — its **Venue Profile** and
