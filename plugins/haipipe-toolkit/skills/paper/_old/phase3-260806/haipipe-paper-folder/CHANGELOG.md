...
## [0.5.2] — 2026-08-05 — dispatched by the door

- `haipipe-paper-lifecycle` is retired (thin-paper phase 2); this skill is now
  dispatched directly by `/haipipe-paper` (the enter get-or-create branch and
  the `folder` verb). Two routing sentences reworded; behavior unchanged.
