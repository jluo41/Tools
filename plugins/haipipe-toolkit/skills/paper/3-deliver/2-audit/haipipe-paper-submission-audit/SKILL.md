---
name: haipipe-paper-submission-audit
...
It is narrower than `haipipe-paper-optimizer`: do not use it to redesign a paper from scratch.
...
```bash
python ~/.codex/skills/haipipe-paper-submission-audit/scripts/check_figure_refs.py path/to/manuscript.md
```
...
- Heavy structural rewrites that belong in `haipipe-paper-optimizer`
