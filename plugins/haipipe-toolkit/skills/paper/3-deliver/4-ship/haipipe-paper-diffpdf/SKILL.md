...
|---|---|---|
| `/haipipe-paper-compile` | clean PDF of the current paper | every save, every iteration |
...
- `haipipe-paper-compile` (sibling) — clean compile, no diff
- `haipipe-paper-edit-manual-review-values` (sibling) — number-by-number audit (run first)
- `haipipe-paper-edit-manual-review-citations` (sibling) — cite-by-cite audit (run first)
