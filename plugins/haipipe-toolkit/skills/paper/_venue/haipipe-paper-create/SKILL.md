...
Which template `3-write-edit/haipipe-paper-edit-write-conference/templates/<X>/` to copy
into the scaffold:
...
ieee_conf                        → 3-write-edit/haipipe-paper-edit-write/templates/ieee_conference.tex
ieee_journal                     → 3-write-edit/haipipe-paper-edit-write/templates/ieee_journal.tex
...
12. **Reuse, don't rewrite.** Section structure comes from
    ...
    `3-write-edit/haipipe-paper-edit-write-scientific/`, templates from
    `3-write-edit/haipipe-paper-edit-write-conference/templates/`. This skill is glue.
