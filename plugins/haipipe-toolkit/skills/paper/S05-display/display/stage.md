...
artifact: 0-lifecycle/S05-display/4-display.md          # THE BRAIN — the only hand-edited stage file
...
generated: 0-lifecycle/S05-display/4-display.tex        # gallery, rebuilt wholesale by sync; hand-editing is a defect
...
build item. The distinction keeps EVIDENCE responsible for answers and the renderer responsible for
