...
## Stage doc (`0-lifecycle/S05-display/`) — the md → tex → pdf trio
...
- [ ] Shaped to the VENUE display set from `0-lifecycle/S01-opening/S-Venue-0-venue.md`; fall back to the venue pack only when that page is absent.
...
- [ ] Exit criteria presented to the user per `../../ref/08-stage-gate.md`; user confirmed; the gate row appended to this stage's S page `## Log`.
