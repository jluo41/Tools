...
**System architecture**
3. [Paper Lifecycle](../1-lifecycle/ref/03-paper-lifecycle.md) -- lifecycle stages, maturity ladder, stage ordering
4. [Lifecycle Map](../1-lifecycle/ref/04-lifecycle-map.md) -- stage routing, command map, skill dispatch
...
8. [Stage Gate](../1-lifecycle/ref/08-stage-gate.md) -- exit criteria + confirm-before-advance gate
9. [Stage Illuminate](../1-lifecycle/ref/09-stage-illuminate.md) -- illuminate + elicit taste before drafting
