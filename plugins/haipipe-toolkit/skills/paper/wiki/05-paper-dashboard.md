...
| `1-resource` | `0-lifecycle/1a-resource/1a-resource.md` exists with its two sections (Demand, Questions); **`n/a` counts as a PASS** -- see the exemption below | `/haipipe-paper resource` |
...
disk predates it, and none of them will ever have a 1a-resource.md written
retroactively.
...
2026-07-14 gets no exemption -- an absent 1a-resource.md is a real frontier.
```
