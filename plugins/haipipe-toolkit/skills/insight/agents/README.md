insight — Agent Roster
========================

Two families, separated by folder — applied THOUGHTFULLY (the way probe
departed from task; see ../DESIGN.md). E goes per-DIKW on BOTH families:
...
task keeps reviewers TYPE-AGNOSTIC ("fixed at 2; adding a task type costs 0
...
the flat symlinks are for the harness. Same convention as task and probe.
