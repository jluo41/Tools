...
- Keep the id prefix and owning register immutable; a changed rung creates a linked successor with fresh open cells and preserved history.
...
- 0.1.0 split the register out of MT00-meta by rung.
