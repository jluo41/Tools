...
Per-plugin SKILLs ship under `page-plugins/` (JL 260815): draw · slide · chat · latex · word · bibex · probe · skill · display, each `haipipe-plugin-<name>` and delta-only over this contract; the roster stays the single list of NAMES, a row going 🟢 brings its skill with it, and meeting/logging/_fixture gain theirs when their rows go live.
