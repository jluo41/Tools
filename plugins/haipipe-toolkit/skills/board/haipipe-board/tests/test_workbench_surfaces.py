"""Workbench surfaces expose material and report honest lifecycle counts."""
...
class WorkbenchSurfaceTest(unittest.TestCase):
    def setUp(self):
...
class WordTitleTest(unittest.TestCase):
    ...
    def test_board_word_caller_passes_canonical_h1_as_document_title(self):
        ...
        class Fake(ExportMixin):
            ...
            def _export_target(self, _p, _workbench):
    ...
    def test_writer_has_a_real_title_style(self):
        writer = (
            ...
            / "servers" / "workbench-page" / "exporters" / "md2docx.py"
        )
