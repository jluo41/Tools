...
metadata:
  ...
  summary: "The 🛠 Skill plugin flattened to a ranked list on JL's ruling: relations, the aligned tick, and drift dates are gone; the order of the cards, set by dragging, is the one judgment."
