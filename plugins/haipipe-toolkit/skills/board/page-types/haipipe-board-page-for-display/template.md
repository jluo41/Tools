<!-- TEMPLATE · ONE DISPLAY UNIT = ONE BOARD PAGE.
     ...
     LOAD BEFORE WRITING, in this order:
       1. `haipipe-board-page/SKILL.md`                     the base frame every page keeps
       2. `haipipe-board/ref/page-template.md`              the authoritative base template
       3. `page-types/haipipe-board-page-for-display/SKILL.md`   this type's contract
...
- `<page-types/haipipe-board-page-for-display/SKILL.md, by its board-relative path>`
