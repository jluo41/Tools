...
**Load:** read the ⚡ Brief at the top of `haipipe-page-outline` FIRST; it is the phase's whole boot. Open the full contract, `haipipe-page`, the matching Page Type, and `haipipe-plugin-outline` only where the brief does not settle the case.
