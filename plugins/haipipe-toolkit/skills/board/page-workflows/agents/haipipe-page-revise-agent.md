...
**Load:** read the ⚡ Brief at the top of `haipipe-page-revise` FIRST; it is the phase's whole boot. Open the full contract, `haipipe-page`, and the matching Page Type only where the brief does not settle the case.
