...
WORKFLOW = SKILLS / "board/page-workflows/haipipe-page-workflow"
...
class InteractiveSkillContractTest(unittest.TestCase):
    def test_relative_instruction_links_resolve(self):
        files = [
            ...
            SKILLS / "board/page-workflows/haipipe-page-content/SKILL.md",
            SKILLS / "board/page-workflows/haipipe-page-content/ref/paragraph-run.md",
    ...
    def test_entry_points_route_to_one_interactive_contract(self):
        for relative in (
            ...
            "board/page-workflows/haipipe-page-content/SKILL.md",
            "board/page-workflows/haipipe-page-outline/SKILL.md",
    ...
    def test_content_default_is_adoption_not_paragraph_allocation(self):
        text = (SKILLS / "board/page-workflows/haipipe-page-content/SKILL.md").read_text()
    ...
    def test_handoff_and_runtime_boundary_are_explicit(self):
        packet = (SKILLS / "board/haipipe-page/ref/user-check-packet.md").read_text()
