...
# /haipipe-board-page-draft · give one Page a promise
...
```text
page-phases/haipipe-board-page-draft/
├── SKILL.md            this phase contract
└── CHANGELOG.md        version history
```

Owns no scripts.
The base is `haipipe-board-page`; Page Type variants live under `page-types/`; the shared question crossing is `probe/haipipe-probe` and begins only when the work enters PROBE.
