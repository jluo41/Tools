---
name: haipipe-page-for-view
description: >-
  Create, repair, or evaluate a first-class View Page that organizes answered
  QA Probes and sources into a readable body, exact-span evidence Cards, one or
  more independently accepted renderer-complete Displays, downstream consumers,
  and a generated `_fixture` distribution with safe consumer manifests. Use for
  pages carrying `page-type: view`, View Page
  naming or folder-boundary questions, View Cards and self-inspection,
