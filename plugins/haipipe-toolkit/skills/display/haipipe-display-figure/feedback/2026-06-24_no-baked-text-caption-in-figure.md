...
regressed: ""
---
"remove the text block... why something not necessary like the text box and text caption baked in the figure? did you use /haipipe-display-figure?"
...
FIX (proposed): haipipe-display-figure should render axis/data only and
