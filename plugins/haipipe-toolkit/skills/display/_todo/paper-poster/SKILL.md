...
[`display/ref/content-plan-spec.md`](../../ref/content-plan-spec.md).
...
[`display/ref/content-plan-spec.md`](../../ref/content-plan-spec.md) — header
...
- ❌ **Not this skill**: how a poster looks — columns, cards, fonts, compile, export.
  That is [`haipipe-display-poster`](../haipipe-display-poster/SKILL.md),
