# Score classes · five rulers, absorbed from skill-set-status 0.3.1 (260831)

Loaded by /skill-inspect --score. Classes and columns are the law; the
INVENTORY mode never scores, the SCORE mode never lists folders.
