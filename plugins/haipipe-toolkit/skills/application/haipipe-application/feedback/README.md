# haipipe-application - Feedback Inbox
...
in a skill-revision pass. This is feedback about the TOOL, not the work it produces.
...
review    /haipipe-application feedback list
