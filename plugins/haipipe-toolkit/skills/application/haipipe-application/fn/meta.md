...
8. On a partition-major board (`ref/partition.md`) this page also carries the Partition Register and Shared Thresholds divisions, per `haipipe-insight-meta` 0.3.0; they are this page's content, not a register's.
