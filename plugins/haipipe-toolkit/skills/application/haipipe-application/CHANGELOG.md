...
- The contradiction sweep, driven by a four-reviewer audit (requirements, workflow, all nine page-type contracts, an A02 cold read) that surfaced 31 findings, 5 blocking. The partition-major layout of 0.13.0 had landed only at the grammar and register layers; the pages it mandates were unclosable under the ladder contracts as written.
