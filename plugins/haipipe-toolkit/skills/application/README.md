...
| a probe card's `## Verdict` block + `verdicted` state (retired 2026-07-14) | the claim's status lives in `0-lifecycle/1-claims/1-claims.md`: `supported \| refuted \| inconclusive` + confidence + claim_type |
