...
1. <beat, e.g. context paragraph> <- P<n> / C<n> (<why this position>)
2. <beat, e.g. finding> <- C<n>, C<n>
3. <beat, e.g. recommendation> <- P<n>
...
Level 3: <action layer> <- P<n> (recommendations)


Claim -> arc mapping
--------------------

One line per load-bearing claim/principle: where it lands and what job it does there.
