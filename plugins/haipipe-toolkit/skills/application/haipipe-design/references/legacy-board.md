<!-- Historical read-only schema. New work follows the current SKILL.md. Do not execute legacy writer/transition instructions. -->
...
Discovery Result/Run pointer when a card's warrant-theory leg requires one, PROVIDED the
