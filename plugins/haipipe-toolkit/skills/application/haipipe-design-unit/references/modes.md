...
| Mode | Creative obligation | Bet obligation | Required source/provenance |
|---|---|---|---|
...
name an authorized insight, a knowledge mechanism, or labeled intuition;
inspiration never becomes warrant.

Theory-driven work distinguishes proposed mechanism from observed effect. The
caller freezes exploration budget, novelty criterion, rationale, uncertainty,
and forecast/failure deliverables before release. Brief-only audience scope is
legal; missing knowledge stays a named gap.

Challenge work identifies what would distinguish the original claim from the
alternative. It does not manufacture measured evidence for either side.

Any rationale, ideation summary, member provenance, mechanism note, uncertainty,
