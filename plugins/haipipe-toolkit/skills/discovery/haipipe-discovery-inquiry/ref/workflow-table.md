...
The three capability skills (`haipipe-discovery-search`, `haipipe-discovery-review`,
`haipipe-discovery-synthesize`) sit at the family root; the on-disk `1_search/`
and `2_review/` folders hold only vendored originals. Search resolves candidates,
Review inspects one source/Result, and Synthesize combines accepted Results.
Semantic ideation is a separate sibling skill, not a Discovery family. None of
these folders is a Run or a controller Step, and this controller's place at the
root grants no phase independent execution or commissioning authority.
...
| Block / Board | bNN_<block>/ + board.md | D1 + haipipe-board | contains Jobs/Groups | Discovery Board source; `board-kind: discovery-block`; generated `board/` is derived |
...
| Synthesize family | haipipe-discovery-synthesize | cross-Result synthesis router | one Page synthesis over many Results | Capability family, chiefly Discovery SYNTHESIZE/CONTENT; never Run r03 |
...
refreshed on disk on 2026-09-21. Some shared Page/Task rows may include a
...
|---|---|---|---|---|---:|---:|---|---|---|
| haipipe-discovery | skills/discovery/haipipe-discovery/SKILL.md | Search/Review/Synthesize door + Board formation | d1.scope, d1.prepare, d1.acquire, d1.synthesize, d1.close | ✅ structurally valid | 0.16.0 | 500 | ?; static quality not assessed | fresh-context 2026-09-20 PASS for workflow routing and Run boundary; fresh-context 2026-09-21 PASS for Board formation/projection | Board helper validated on a temporary Block; a substantive Page is required for the Board static-body gate |
| haipipe-discovery-inquiry | skills/discovery/haipipe-discovery-inquiry/SKILL.md | Discovery Run Workflow Definition / Folder + Board contract | d1.scope, d1.prepare, d1.acquire, d1.synthesize, d1.close | ✅ structurally valid | 0.7.0 | 228 | ?; static quality not assessed | terminology update inspected after cold route validation | Page Workflow Steps do not create Discovery Runs; Board projection is derived from BJTR tree |
...
| haipipe-page-workflow | skills/page/haipipe-page-workflow/SKILL.md | Page Workflow controller | d1.synthesize | ? unknown | 0.45.0 | 453 | ?; not assessed in this revision | ? | current Page Run/release-barrier contract inspected; fresh cross-family validation remains |
| haipipe-page-context | skills/page/workflow-runs/haipipe-page-context/SKILL.md | Page Workflow Step contract | d1.synthesize | ? unknown | 0.1.3 | 205 | ?; not assessed in this revision | ? | re-audit on shared-contract change |
| haipipe-page-structure | skills/page/workflow-runs/haipipe-page-structure/SKILL.md | Page Workflow Step contract | d1.synthesize | ? unknown | 0.42.0 | 731 | ?; not assessed in this revision | ? | current Page-global paragraph and Outline contract inspected |
| haipipe-page-evidence | skills/page/workflow-runs/haipipe-page-evidence/SKILL.md | skipped typed-local Page Workflow Step contract | d1.synthesize | ? unknown | 0.22.1 | 342 | ?; not assessed in this revision | ? | D1 root skips typed local LAND but keeps direct Result/cite lineage |
| haipipe-page-writing | skills/page/workflow-runs/haipipe-page-writing/SKILL.md | Page Workflow Step contract | d1.synthesize | ? unknown | 0.14.0 | 237 | ?; not assessed in this revision | ? | current Page release barrier inspected |
| haipipe-page-check | skills/page/workflow-runs/haipipe-page-check/SKILL.md | Page Workflow Step contract | d1.synthesize | ? unknown | 0.8.1 | 346 | ?; not assessed in this revision | ? | re-audit on shared-contract change |
| haipipe-workbench-page | skills/page/haipipe-workbench-page/SKILL.md | Outline/Evidence artifact contract | d1.synthesize | ? unknown | 0.65.0 | 566 | ?; not assessed in this revision | ? | current nested Evidence/Outline contract inspected; stale internal `rp01` prose references remain in the Page owner |
...
| haipipe-workbench-page | skills/page/haipipe-workbench-page/ref/run-space.md | read-only presenter | d1.acquire, d1.close | ? unknown | 0.23.0 | 333 | ?; not assessed in this revision | ? | current two-lane presenter inspected |
| haipipe-discovery-search | skills/discovery/haipipe-discovery-search/SKILL.md | acquisition/identity router | d1.acquire | ✅ structurally valid | 0.7.1 | 137 | ?; static quality not assessed | fresh-context 2026-09-20 route PASS; external search unverified | External provider routing stays below canonical identity and Run allocation |
...
| haipipe-discovery-synthesize | skills/discovery/haipipe-discovery-synthesize/SKILL.md | cross-Result synthesis router | d1.synthesize | ✅ structurally valid | 0.3.1 | 170 | ?; static quality not assessed | fresh-context 2026-09-20 conflict scenario PASS | Preserve conflicting Results; no local D1 or Page Run |
