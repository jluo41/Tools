...
composition belongs to `haipipe-discovery-synthesize`.
This skill sits at the family root; the `1_search/` folder beside it holds the
vendored channel and reader originals only, not a Block, Job, Task, or Run. Use `../haipipe-discovery/ref/bjtr-alignment.md` when an older
