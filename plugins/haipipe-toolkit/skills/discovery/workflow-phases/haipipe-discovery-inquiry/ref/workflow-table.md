...
PAGE RUN LANE             rp00_mermaid-structure -> rpNN_pNN[-pNN]
```

There is no separate `haipipe-discovery-workflow` skill directory to load.
This D1 phase is the Folder-contract registry identity and owns the domain
Workflow Table. The Page workflow remains a separate shared authority, not a
second Discovery workflow skill.
...
D1 phase, Run commissioner, Result writer, or Bib owner.
...
| d1.synthesize | Discovery | D1 Inquiry | SYNTHESIZE | Combine completed Review packets and Results into the promised article. This cycle orchestrates; Page phases own every Page mutation. | Accepted Results; review packets; type promise; manifest; current Page receipts. | haipipe-discovery -> haipipe-discovery-inquiry -> haipipe-discovery-synthesize -> optional synthesis craft (research-genealogy / Result-to-Claim) -> haipipe-page -> haipipe-page-workflow -> current Page phase -> declared craft worker -> shared CHECK | Discovery orchestrator plus current Page-phase producer/checker | Discovery cycle writes only Task-side progress and optional typed record. Page 00–04 owns Context, generated Outline, Content, and Check artifacts; D1's direct Result/cite lineage makes typed local EVIDENCE/LAND skippable. | none in D1's local inventory; Page-owned interaction may allocate `rp00_mermaid-structure` then selected `rpNN_pNN[-pNN]`, while CONTENT consumes those Results after the Page release barrier. | A CHECKed root Page, optional typed Task record, derived Bib, and exact Result/cite lineage. | The Page release barrier is open, Page workflow reaches 04 CHECK, every factual claim resolves to completed Discovery Results, and missing evidence routes back to ACQUIRE. | d1.acquire, d1.close, or HOLD. | Shared Page gates apply inside Page workflow; D1 adds no duplicate Page ruling. |
...
| Page | interactive-writing | shared Page workflow, not D1 | `rp00` plus selected `rpNN` | whole-Page structure, then one selected paragraph group; Page owns feedback, Versions, Steps, and acceptance | Page Run Result/accepted preview consumed by CONTENT | no |
...
|---|---|---|---|---|---:|---:|---|---|---|
| haipipe-discovery | skills/discovery/haipipe-discovery/SKILL.md | Search/Review/Synthesize door | d1.scope, d1.prepare, d1.acquire, d1.synthesize, d1.close | ✅ structurally valid | 0.13.0 | 461 | ?; static quality not assessed | fresh-context 2026-09-13 PASS | `rpNN` stays outside the D1 inventory and the Page release barrier is preserved |
| haipipe-discovery-inquiry | skills/discovery/workflow-phases/haipipe-discovery-inquiry/SKILL.md | phase machine / Folder contract | d1.scope, d1.prepare, d1.acquire, d1.synthesize, d1.close | ✅ structurally valid | 0.6.0 | 202 | ?; static quality not assessed | fresh-context 2026-09-13 PASS | Page Run boundary and direct Result/cite handoff confirmed |
...
| haipipe-page-workflow | skills/page/page-workflows/haipipe-page-workflow/SKILL.md | Page phase machine | d1.synthesize | ? unknown | 0.45.0 | 453 | ?; not assessed in this revision | ? | current Page Run/release-barrier contract inspected; fresh cross-family validation remains |
| haipipe-page-context | skills/page/page-workflows/haipipe-page-context/SKILL.md | Page phase contract | d1.synthesize | ? unknown | 0.1.3 | 205 | ?; not assessed in this revision | ? | re-audit on shared-contract change |
| haipipe-page-outline | skills/page/page-workflows/haipipe-page-outline/SKILL.md | Page phase contract | d1.synthesize | ? unknown | 0.42.0 | 731 | ?; not assessed in this revision | ? | current Page-global paragraph and Outline contract inspected |
| haipipe-page-evidence | skills/page/page-workflows/haipipe-page-evidence/SKILL.md | skipped typed-local Page phase contract | d1.synthesize | ? unknown | 0.22.1 | 342 | ?; not assessed in this revision | ? | D1 root skips typed local LAND but keeps direct Result/cite lineage |
| haipipe-page-content | skills/page/page-workflows/haipipe-page-content/SKILL.md | Page phase contract | d1.synthesize | ? unknown | 0.14.0 | 237 | ?; not assessed in this revision | ? | current Page release barrier inspected |
| haipipe-page-check | skills/page/page-workflows/haipipe-page-check/SKILL.md | Page phase contract | d1.synthesize | ? unknown | 0.8.1 | 346 | ?; not assessed in this revision | ? | re-audit on shared-contract change |
...
| haipipe-discovery-review | skills/discovery/2_review/haipipe-discovery-review/SKILL.md | per-Subject review router | d1.acquire | ✅ structurally valid | 0.7.0 | 77 | ?; static quality not assessed | pending fresh validation after external review-packet update | Validate extraction/appraisal and unresolved citation handling |
...
| haipipe-discovery-synthesize | skills/discovery/3_synthesize/haipipe-discovery-synthesize/SKILL.md | cross-Result synthesis router | d1.synthesize | ✅ structurally valid | 0.3.0 | 160 | ?; static quality not assessed | fresh-context 2026-09-13 PASS | Every Page claim maps to accepted Results; no local D1 or Page Run |
