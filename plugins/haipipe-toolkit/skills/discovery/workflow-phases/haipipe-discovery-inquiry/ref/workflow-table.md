...
refreshed on disk on 2026-09-08. Some shared Page/Task rows may include a
...
|---|---|---|---|---|---:|---:|---|---|---|
| haipipe-discovery | skills/discovery/haipipe-discovery/SKILL.md | Search/Review/Synthesize door | d1.scope, d1.prepare, d1.acquire, d1.synthesize, d1.close | ✅ structurally valid | 0.11.0 | 440 | ?; static quality not assessed | pending fresh validation after external-capability registry update | External worker packet routing and no-authority boundary need fresh-context validation |
| haipipe-discovery-inquiry | skills/discovery/workflow-phases/haipipe-discovery-inquiry/SKILL.md | phase machine / Folder contract | d1.scope, d1.prepare, d1.acquire, d1.synthesize, d1.close | ✅ structurally valid | 0.5.1 | 177 | ?; static quality not assessed | fresh-context 2026-09-04 PASS; skills/discovery/haipipe-discovery/feedback/2026-09-04-workflow-field-test.md; fresh-context 2026-09-07 PASS (/root/discovery_external_refresh_fieldtest) | Gemini unavailable in test; optional live-source execution remains to be exercised |
...
| haipipe-page | skills/page/haipipe-page/SKILL.md | Page door | d1.synthesize | ? unknown | 0.60.4 | 569 | ?; not assessed in this revision | ? | re-audit on shared-contract change |
| haipipe-page-workflow | skills/page/page-workflows/haipipe-page-workflow/SKILL.md | Page phase machine | d1.synthesize | ? unknown | 0.29.1 | 345 | ?; not assessed in this revision | ? | re-audit on shared-contract change |
| haipipe-page-context | skills/page/page-workflows/haipipe-page-context/SKILL.md | Page phase contract | d1.synthesize | ? unknown | 0.1.3 | 204 | ?; not assessed in this revision | ? | re-audit on shared-contract change |
| haipipe-page-outline | skills/page/page-workflows/haipipe-page-outline/SKILL.md | Page phase contract | d1.synthesize | ? unknown | 0.32.1 | 612 | ?; not assessed in this revision | ? | re-audit on shared-contract change |
| haipipe-page-evidence | skills/page/page-workflows/haipipe-page-evidence/SKILL.md | skipped Page phase contract | d1.synthesize | ? unknown | 0.22.0 | 337 | ?; not assessed in this revision | ? | re-audit on shared-contract change |
| haipipe-page-content | skills/page/page-workflows/haipipe-page-content/SKILL.md | Page phase contract | d1.synthesize | ? unknown | 0.8.4 | 322 | ?; not assessed in this revision | ? | re-audit on shared-contract change |
...
| haipipe-plugin-outline | skills/page/page-plugins/haipipe-plugin-outline/SKILL.md | Outline/Evidence artifact contract | d1.synthesize | ? unknown | 0.46.0 | 444 | ?; not assessed in this revision | ? | re-audit on shared-contract change |
...
| haipipe-plugin-runs | skills/page/page-plugins/haipipe-plugin-runs/SKILL.md | read-only presenter | d1.acquire, d1.close | ? unknown | 0.9.7 | 233 | ?; not assessed in this revision | ? | re-audit on shared-contract change |
