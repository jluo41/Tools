...
metadata:
  ...
  summary: "CREATOR agent for D_probe Design Mode B — auto-generate probe ideas."
  changelog:
...
D_probe/ref/probe-yaml-schema.md   field spec for probe.yaml
```
