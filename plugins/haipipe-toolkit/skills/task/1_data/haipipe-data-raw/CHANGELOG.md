...
- Adds § Dataset naming: `<cohort>-v<yymmdd>`, the extraction launch day, typed once as `raw_data_name`; downstream stores inherit it; a new extraction is a new dataset.
