...
4. If none exists, create a folded Q or S Page through `haipipe-page` with `page-type: insight` and an explicit `insight-target`.
...
7. Run the Page workflow and close only under `haipipe-page-for-insight`.
