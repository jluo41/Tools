"""
Reference template — Intent-bearing docstring for a task run script.
...
The Task Reviewer agent (Tools/plugins/haipipe-toolkit/skills/task/agents/haipipe-task-reviewer-agent.md)
