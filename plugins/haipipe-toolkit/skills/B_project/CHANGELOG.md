...
### Changed
- **`ref/project-structure.md` notebooks/ rules** aligned with the new C_task notebook policy:
  - documented the `_meta.notebook: full | thin | off` retention knob (run.sh applies it; cross-ref to `C_task/haipipe-task/ref/authoring-conventions.md §7`);
