...
- ↪ Covered elsewhere
  Who owns the filename is `QB2b`; which dependency declaration is authoritative is `QA8`; whether display's grain is per-unit is `QB2b`.
