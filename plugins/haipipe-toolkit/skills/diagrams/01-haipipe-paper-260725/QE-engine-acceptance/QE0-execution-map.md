...
## Boundary
- ✅ Covered here
  Execute-record shape, execution modes, and the first MISQ candidate record.
- ↪ Covered by QF through QP
  The desired delivery, canonical content, and human completion gate.
- ↪ Covered by QS0
  The reusable skill route that an execution invokes.
- ↪ Covered by QO0
  The Build deliverable and its promotion law.
...
| Fresh agent | A clean-context agent finds the entry, follows the route, and stops at the right boundary | `QE2` stage acceptance run |
...
| Reopen path | Repair the owning Display projection, then rerun isolated G4 from QO0 |
...
- [ ] 🧪 Add a fresh-agent execution for a complete route.
      `QE2` remains the behavioral acceptance owner and must observe process as well as output.
...
## Files
- `QO-delivery-build/QO0-delivery-build.md`
