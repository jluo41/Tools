...
One mirror page per shipped unit the paper work runs on: the paper family's own skills and the Board substrate it stands on. A mirror page is GENERATED by `skillpage.py`, carries the unit's own bytes in managed spans, and is never counted in the settled total; what a person writes on it is the Opening, the workflow figure, the unit's open Aims, and the health judgment on `state:`. Split out of QC on 260805 (JL) so the Engine group argues designs and this group tracks shipped units.

```text
⚙️ ENGINE                      📋 PAGES · the working record          📂 FOLDER
─────────────────────────      ───────────────────────────────────    ────────────────────────
skillpage.py new / sync     ◀── Skill-0–5 · 12–14  the paper family  ──▶  skills/paper/
...
stages/            ../../paper/haipipe-paper-stage/stages/
index.yml          ../../paper/haipipe-paper-stage/stages/index.yml
CONTRACT.md        ../../paper/haipipe-paper-stage/stages/CONTRACT.md
venue/             ../../paper/venue/
...
haipipe-paper-lifecycle      ../../paper/haipipe-paper-lifecycle/
...
haipipe-paper-revise-place   ../../paper/workers/haipipe-paper-revise-place/
haipipe-paper-revise-results ../../paper/workers/haipipe-paper-revise-results/
...
haipipe-paper-check-evidence ../../paper/workers/haipipe-paper-check-evidence/
