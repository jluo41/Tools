# Who owns which region of the shared page
state: 🟡 PARTIAL
owner: JL
...
- ↪ Covered elsewhere
  The collaboration as a whole is `QA6`; how work is DRIVEN from a page is `QA8`; what a board is, and its face grammar, belong to the tool's own board at `../01-boardform-260722/`.
...
```
 ...
 ② WHICH DEPENDENCY DECLARATION BINDS
...
(QBc1-one-file-two-skills · was 🟡 PARTIAL)
...
(QBc2-two-dependency-declarations · was ✅ SETTLED)
...
(QBc3-where-state-lives · was 🟡 PARTIAL)
...
### Who creates a page?
(QBc4-who-creates-a-page · was ✅ SETTLED)
...
(QBc5-dialect-boundary · was ✅ RULED)
