...
**The shape of this page is not this page's own** (260803). It comes from `../../board/page-types/haipipe-page-for-venue/SKILL.md`, whose reference implementation is `QBv1-misq.md`, and a rule changed here is changed in that contract in the same pass:
