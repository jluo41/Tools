...
state: 🟡 PARTIAL · 12 exemplars · 7 sections · taste ✓ · the vocabulary switch is recorded nowhere a writer reads
owner: JL
...
**Never transcribe the section norms**: word budgets live in `MS-IS/MS-IS-<section>/style.md` and are cited, never copied.
...
```text
  ...
  📊 12 exemplars · the most economics-adjacent of the three
