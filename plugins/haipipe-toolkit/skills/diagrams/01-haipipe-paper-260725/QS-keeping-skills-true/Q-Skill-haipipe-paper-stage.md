...
## Diagram
<!-- haipipe:skill:tree:start 852925280841b981 paper/1-lifecycle/haipipe-paper-stage -->
...
## Content
<!-- haipipe:skill:body:start 852925280841b981 paper/1-lifecycle/haipipe-paper-stage -->
...
check-contracts.py                 190 ln  Check every stage contract against stages/CONTRACT.md, and against a real paper.
create-page.py                     387 ln  Create one paper lifecycle S page through the Board's shell primitive.
stages/0-seed/stage.md             165 ln  CONTRACT — machine-readable. No `name:` field: this is DATA the router reads,
...
stages/1a-resource/stage.md        184 ln  CONTRACT — machine-readable. No `name:` field: this is DATA the router reads,
...
stages/1b-claims/stage.md          181 ln  CONTRACT — machine-readable. No `name:` field: this is DATA the router reads,
...
stages/2a-venue/stage.md           242 ln  CONTRACT — machine-readable. No `name:` field: this is DATA the router reads,
...
stages/2b-pitch/stage.md           227 ln  CONTRACT — machine-readable. No `name:` field: this is DATA the router reads,
...
stages/3-narrative/stage.md        224 ln  CONTRACT — machine-readable. No `name:` field: this is DATA the router reads,
...
stages/4-display/stage.md          280 ln  CONTRACT — machine-readable. No `name:` field: this is DATA the router reads,
stages/4-display/template.md       161 ln  <!-- TEMPLATE · ONE DISPLAY ASSET = ONE S PAGE.
stages/5-section-edit/stage.md     291 ln  CONTRACT — machine-readable. No `name:` field: this is DATA the router reads,
...
stages/CONTRACT.md                 171 ln  The stage contract form
...
<!-- haipipe:skill:log:start 852925280841b981 paper/1-lifecycle/haipipe-paper-stage -->
