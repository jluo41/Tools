...
- ↪ Covered elsewhere
  Which layer owns which part is `QD1`; the renderer's own input and output contract is `QD2`; the spending ladder itself is `QB3b`; what makes the result auditable afterwards is `QD6`.
