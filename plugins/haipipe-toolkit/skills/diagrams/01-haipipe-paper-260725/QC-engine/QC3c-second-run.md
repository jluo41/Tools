...
```
   ...
   ② ref/09-stage-illuminate.md:25
        ...
        📍 IT MOVED, AND IT WAS PROMOTED. This began as the
           ...
           and the rule now sits in a ref doc that `../../paper/1-lifecycle/ref/08-stage-gate.md`
...
- [ ] 🔧 Retire or generalise the local rules the ruling replaces
      Seven files hold the eight: `create-page.py`, `../../paper/1-lifecycle/ref/09-stage-illuminate.md`, `stages/5-section-edit/template.md` (plus 95 venue copies), `../../paper/1-lifecycle/ref/08-stage-gate.md`, `haipipe-paper-rebuttal/SKILL.md`, `stages/5-section-edit/stage.md` (two of them), `../../paper/2-phase/REF/prose-quality.md`. A local rule that survives the ruling is a local rule that will contradict it later.
...
## States
Ruled and declared 260727. `on_rerun: diff-and-ask` is in all eight `stage.md` contracts, the rule is specified once in `../../paper/1-lifecycle/haipipe-paper-stage/stages/CONTRACT.md` under "The second run", and the two preservation rules now match the lane shape `> <ACTOR>:` instead of the one id that was never on a page.
...
- `../../paper/2-phase/REF/prose-quality.md`
...
- `../../paper/1-lifecycle/ref/09-stage-illuminate.md`
