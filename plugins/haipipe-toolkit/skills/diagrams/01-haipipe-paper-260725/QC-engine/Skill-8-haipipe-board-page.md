...
## Diagram
<!-- haipipe:skill:tree:start 901352b6355ebeba board/haipipe-board-page -->

**What `haipipe-board-page` ships**: every file in the folder, with the one-line purpose each one states for itself.

```
haipipe-board-page/
  CHANGELOG.md         187 ln  haipipe-board-page · Changelog
  SKILL.md             365 ln  /haipipe-board-page · the page, as a contract you can load
```
...
## Content
<!-- haipipe:skill:body:start 901352b6355ebeba board/haipipe-board-page -->

**haipipe-board-page** · `0.13.0` · last shipped 2026-08-04

- folder   `board/haipipe-board-page/`
- tools    not declared
- summary  Makes Page Type and Page Phase orthogonal: page-types/ holds for-* variants, page-phases/ holds DRAFT, PROBE, REVISE, and CHECK.
...
- 2 · 🎭 Four Page Phases, independent of Page Type
      ...
      `ADVANCE` is deliberately absent: the base adopts the vocabulary and boundaries now, while a future router must earn a new verb with a concrete need.
...
- 3 · 📑 The sections, in their fixed on-stage order
      **The sections in order**: what each owes a reader, and how much a machine may write into it.
      ...
      6   Files              the action map, grouped by ACTION     DRAFT/REVISE maintain
...
- 4 · 🚪 Two verbs, and this skill is the door for both
...
- 5 · ✍️ What both verbs are writing to
...
<!-- haipipe:skill:log:start 901352b6355ebeba board/haipipe-board-page -->
