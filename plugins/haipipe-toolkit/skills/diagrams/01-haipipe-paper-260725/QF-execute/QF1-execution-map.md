...
- `QB-delivery/QB9-build.md` · owns the Build delivery contract and the G5 promotion law
- `QC-engine/QC1-delivery-skill-map.md` · owns the Delivery × Engine route map
- `QF3-fresh-agent-run.md` · owns the behavioural mode this page cannot produce
