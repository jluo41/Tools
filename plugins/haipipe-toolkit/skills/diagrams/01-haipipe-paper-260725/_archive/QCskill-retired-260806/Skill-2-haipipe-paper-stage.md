...
state: ⚫ RETIRED 260805 · Steps 1-4 absorbed into the door paper/haipipe-paper/SKILL.md; stage data stayed in paper/S01-opening … S10-round/
owner: JL
method: three managed spans sync from the skill folder; everything else is written by hand

**Retired 260805 (thin-paper phase 2, QC6).** The one-stage executor's Steps 1-4 were absorbed into the door: `paper/haipipe-paper/SKILL.md` now owns index.yml resolution, the one-stage rule, `create-page.py`, and the checker convention, and this folder's `stages/`, `create-page.py`, `check-contracts.py`, `section-stats.py`, and `ref/` moved into `paper/haipipe-paper/`. The stage DATA (stage.md + template.md + craft files) stayed in `paper/S01-opening` through `paper/S10-round/`. What remained of the folder retired to `paper/_old/haipipe-paper-stage/`.
...
## Log
- 260806 0130 · [REVISE-CC] retirement recorded: Steps 1-4 absorbed into paper/haipipe-paper/SKILL.md; stage data in paper/S01-opening … S10-round/
