...
state: ⚫ RETIRED 260805 · page logic in board/page-phases/haipipe-board-page-draft; LaTeX craft became stage data files
owner: JL
method: three managed spans sync from the skill folder; everything else is written by hand

**Retired 260805 (thin-paper phase 2, QC6).** The DRAFT worker split along the page/craft seam: the page logic lives on in `board/page-phases/haipipe-board-page-draft`, and the LaTeX craft became stage data files loaded through each stage.md `craft:` list, at `paper/S03-literature/citation-craft.md`, `paper/S04-value/values-craft.md`, and `paper/S05-display/display/draft-craft.md`. The worker folders retired to `paper/_old/workers/`. The account below is the pre-fold record and stays as written.
...
## Log
- 260806 0130 · [REVISE-CC] retirement recorded: board/page-phases/haipipe-board-page-draft + S03/S04/S05 craft files (citation-craft.md, values-craft.md, draft-craft.md)
