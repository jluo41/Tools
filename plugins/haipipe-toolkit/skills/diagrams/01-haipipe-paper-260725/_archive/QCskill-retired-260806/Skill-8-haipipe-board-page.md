...
## Log
- 260806 0150 · [REVISE-CC] card synced to disk truth after 260805 (ten types · thin-paper phase 2 · first live RUN); version lifted to 0.20.1 and the resolve-order's last slot now reads family craft files, not family worker
