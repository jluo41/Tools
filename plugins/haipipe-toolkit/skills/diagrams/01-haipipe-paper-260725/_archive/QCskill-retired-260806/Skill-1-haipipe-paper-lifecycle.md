...
state: ⚫ RETIRED 260805 · absorbed into the one door paper/haipipe-paper/SKILL.md
owner: JL
method: three managed spans sync from the skill folder; everything else is written by hand

**Retired 260805 (thin-paper phase 2, QC6).** The lifecycle router was absorbed into the one door: `paper/haipipe-paper/SKILL.md` now natively owns stage sequencing, global-pass mode, and the phase-verb pass-through this page described. The skill folder retired to `paper/_old/haipipe-paper-lifecycle/`. The account below is the pre-fold record and stays as written.
...
haipipe-paper-lifecycle/
  ...
  SKILL.md                             520 ln  Skill: haipipe-paper-lifecycle (orchestrator)
```
...
## Log
- 260806 0130 · [REVISE-CC] retirement recorded: absorbed into paper/haipipe-paper/SKILL.md (stage sequencing, global-pass mode, phase-verb pass-through)
