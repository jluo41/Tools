...
## Opening
How do appendix prose, prompt templates, tables, and wrappers remain source-complete and reviewable?

Scope: This page covers Appendix authority, lettered units, and wrapper/leaf projection. Build covers Manifest coverage and candidate checks.

## Diagram
```text
S-Appendix source divisions + A–F gates → candidate appendices/ → appendix driver
```
...
## Files
- `0-lifecycle/5-appendix/`
- `appendices/`

## Law
An appendix wrapper contains wiring only; every prose/template leaf must have an explicit authoritative source region.
