...
## Opening
What belongs under Present, and what remains owned by the paper?

Scope: This page covers Slides and posters as audience-facing projections. Display covers Reusable visual units and promoted assets.

## Diagram
```text
accepted paper argument + displays → slides
                                   → poster
```
...
## Files
- `5-present/paper-slides/`
- `5-present/paper-poster/`
