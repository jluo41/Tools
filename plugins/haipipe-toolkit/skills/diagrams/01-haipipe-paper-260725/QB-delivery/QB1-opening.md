...
Scope: This page covers Seed, venue, pitch, and narrative as one Opening sequence. Work covers Growing the discovery and task banks that the opening reveals are needed; accepted answers may reopen the pitch or narrative. Main covers The manuscript Introduction; Opening is lifecycle control, not §1 prose.
