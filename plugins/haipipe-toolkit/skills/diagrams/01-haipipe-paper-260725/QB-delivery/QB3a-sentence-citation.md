...
```
 ...
 WHERE THIS PAGE'S EVIDENCE LIVES IN THE BOARD FOLDER
   the prose      QB3a-sentence-citation.md  ## Content   (S1 S2 S3)
...
The paragraph's other three sentences are the sibling pages': S4 the numbers is `QB4a`, S5 the table is `QB5a`, S6 the figure is `QB5b`.
