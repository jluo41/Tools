...
**Where this page sits**: QB11 heads the section series, and placement lives here because first-mention order is a fact about a sequence.
QB13c owns what the caption and label SAY, QB13a owns the folder the float lives in, QB12c and QB12d own what a citing sentence means, and QB11a owns float numbering across the document.
...
- `QB11-delivery-section.md` · the series head, which owns why placement is a section rule
