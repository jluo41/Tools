...
Scope: This page covers Build plus diffusion/distribution: manifest wiring, LaTeX/Word adapters, isolated candidates, handoffs, and explicit promotion. Main and Appendix covers Authoritative manuscript content and human page gates. Present covers Slides and posters. QF1 covers The concrete execution record, including receipts, compile outcome, and failure-to-reopen path.
...
| Engine route | `haipipe-paper-deliver` and `haipipe-paper-project`, with QB9a/QB9b adapters, conform, compile, and ship leaves. |
...
`QF1` owns the full execution record and its failure-to-reopen link.
