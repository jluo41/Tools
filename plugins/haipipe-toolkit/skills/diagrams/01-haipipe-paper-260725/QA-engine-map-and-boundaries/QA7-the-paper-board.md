...
- ↪ Covered elsewhere
  The design board is the opposite object and is `QA3`; what else is in the paper folder is `QA6`; the grain that decides how many S pages a stage gets is `QB2b`; who creates one is `QA8`.
