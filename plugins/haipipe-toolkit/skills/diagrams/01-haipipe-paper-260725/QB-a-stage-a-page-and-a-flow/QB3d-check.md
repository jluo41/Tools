...
- ↪ Covered elsewhere
  Why the earlier phases need no gate is `QB3b`; the why-comments a gate reads are `QB3c`; what a re-run does to a page that already passed is `QB2c`; how a page's state is displayed is `QA9`.
