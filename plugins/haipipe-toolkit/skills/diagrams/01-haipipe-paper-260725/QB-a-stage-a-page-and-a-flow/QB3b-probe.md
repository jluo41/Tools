...
- ↪ Covered elsewhere
  The five-step loop, the stake split and the bank's own ladder belong to `/haipipe-probe`, which this family does not own: see `QA5` and `../01-probe-qa-260726/`. What DRAFT raised is `QB3a`; what REVISE does with a landed answer is `QB3c`.
