...
```text
   ...
   🎙 echo-meeting (Obsidian plugin, jluo41)
      records · transcribes · summarizes
              │
              ▼
   2-QB-board/Design-1-haipipe-board/meeting/260723-meeting.md        8,573 words · 1,045 transcript lines
...
page_files(d)          matches a NAME, at any depth
  ...
  anything else                    ❌ 2-QB-board/Design-1-haipipe-board/meeting/260723-meeting.md
