...
- 260801 JL · 🐢 Navigation was re-downloading a page list it throws away
  ...
  Every page file carries the complete page list, 112 KB of it, and the router swaps only `div.wrap`, so on a median 136 KB page 82% of the bytes are discarded on arrival; across the tree that is 7.10 MB of 9.40 MB spent on 65 copies of one page list.
...
- `7-QC-engine/QC3a-writepath/QC3a-writepath.md`
  The return direction's addressing contract, which this face uses and does not restate.
- `8-QO-operating/QO1-split-workspace/QO1-split-workspace.md`
