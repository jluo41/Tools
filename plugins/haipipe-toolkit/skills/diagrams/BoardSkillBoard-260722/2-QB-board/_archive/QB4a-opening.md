...
/_excalidraw/?board=Tools/plugins/haipipe-toolkit/skills/diagrams/BoardSkillBoard-260722/board.excalidraw&frame=QAa1
...
source    ## Opening = one question lead + one rationale paragraph
          (## Question accepted as its legacy alias) · no ## Boundary,
          scope is the lead's job (JL 260731) · S: stage.py writes the
          managed contract
