...
- B8 · ⚠️ 12 more sentences in this division are not planned here yet   🎯 aim
...
- B8 · ⚠️ 26 more sentences in this division are not planned here yet   🎯 aim

## C3 · Getting older pages ready

### C3.P1 · it suggests the marks, a person checks them, and the file keeps them
- B1 · Pages written before the mark existed have none, so each shows as a single 🌐 card.   🎯 A3.1
- B2 · Fixing that is a one-time pass per page.   🎯 A3.1
- B3 · An AI suggests a mark for each goal and progress line, the suggestion is written into the page as ordinary text, and a person reads the change before it lands.   🎯 A3.1
- B4 · After that pass the answer lives in the page, and no AI runs when you open the tab.   ✅ have it
- B5 · New pages take their marks as they are written, because whoever writes a goal knows which part it serves.   🎯 aim
