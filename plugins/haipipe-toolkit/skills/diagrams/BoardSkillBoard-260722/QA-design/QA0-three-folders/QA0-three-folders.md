...
**Covered elsewhere**: Where a board folder lives and what it is named is `QC1`; a page living inside its home folder is `QC4`; the words this family uses are `QB1`; how a topic becomes pages and groups is `QA2`; which units the family ships is `QC1b` and the `_archive/` roster.
...
```
  ...
  🗂 ② skills/diagrams/BoardSkillBoard-260722/ THIS board  ← you are here
       board.md            the manifest: Topic · Pipeline · Board Map
                           · Related Folders · Board Structure · Pages · Links
       QA-design/ QB-board/ QC-engine/ _archive/
       QO-operating/ QO-operating/ QF-execute/ QG-meeting/   one folder per group
...
After the 260730 restructure, the 260731 QD split, and the later QCskill and QG additions this board has eight: `QA-design/`, `QB-board/`, `QC-engine/`, `_archive/`, `QO-operating/`, `QO-operating/`, `QF-execute/`, `QG-meeting/`.
