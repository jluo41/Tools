...
**Where this page sits**: `QO5` owns the three-pane workspace in which a drawing will open, and `QPf2` owns how one Page attaches a drawing to its Diagram section.
