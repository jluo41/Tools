...
```text
   📄 QA-design/QA4-board-skillset/slide/QA4-board-skillset-deck.html      ← ONE file
        │
...
![slide 1 · cover](QA-design/QA4-board-skillset/slide/QA4-board-skillset-deck.html?preview=1#s1)
- accepted: ⬜ · slide 1 · source: `board.md` opening prose · rendered: 260805

![slide 2 · the problem](QA-design/QA4-board-skillset/slide/QA4-board-skillset-deck.html?preview=2#s2)
...
Then the names: `haipipe-board` the engine, `haipipe-page` the page contract, the verbs for movement; if they remember one name, it is `haipipe-page`.

![slide 3 · the shape](QA-design/QA4-board-skillset/slide/QA4-board-skillset-deck.html?preview=3#s3)
- accepted: ⬜ · slide 3 · source: `QB4` (the page grammar) · rendered: 260805

![slide 4 · the skill set](QA-design/QA4-board-skillset/slide/QA4-board-skillset-deck.html?preview=4#s4)
...
![slide 5 · type × phase](QA-design/QA4-board-skillset/slide/QA4-board-skillset-deck.html?preview=5#s5)
- accepted: ⬜ · slide 5 · source: `QB5` `QB6` · rendered: 260805

![slide 6 · the loop](QA-design/QA4-board-skillset/slide/QA4-board-skillset-deck.html?preview=6#s6)
...
![slide 7 · the proof](QA-design/QA4-board-skillset/slide/QA4-board-skillset-deck.html?preview=7#s7)
...
- ✅ P5 · The contract's embed rule matches what this page does, and its changelog names this page as the reason: `haipipe-page-for-slide/CHANGELOG.md` 0.4.0 records the re-ruling this page forced and names QA4 in its bullets, and 0.5.0 cites QA4 again. Two facts this row owes: the contract shipped 0.5.0 on 260806, which `## Files` lagged at 0.4.0 until it was repointed the same day, and 0.5.0 records that this deck's flat path `QA-design/QA4-board-skillset/slide/QA4-board-skillset-deck.html` predates its new companion-folder rule and does not follow it. Neither touches the embed rule P5 names.
...
- `../../board/page-types/haipipe-page-for-slide/SKILL.md`
  The for-slide contract this page tests, now 0.5.0 in its own frontmatter; corrected here three times (live html embed at 0.2.0, beat strip at 0.3.0, per-slide accept rows at 0.4.0). 0.5.0 shipped without this page: it adds `template.md`, fixes the acceptance row's four fields, and records that this deck's flat path `QA-design/QA4-board-skillset/slide/QA4-board-skillset-deck.html` predates the companion-folder rule and does not follow it.
...
- `QA-design/QA4-board-skillset/slide/QA4-board-skillset-deck.html`
...
- 260806 2218 · [REVISE-CC] type-conformance pass against haipipe-page-for-slide; cleared the leftover beat-strip claims the re-ruling left behind (Diagram review lane, §4's `?preview=A-B`, P1's "as a strip") and repointed the Files contract entry from 0.2.0 to 0.4.0
