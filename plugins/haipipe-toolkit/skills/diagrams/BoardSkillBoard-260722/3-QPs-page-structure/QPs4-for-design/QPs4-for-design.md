...
```text
  📂 3-QPs-page-structure/                      ← the group folder
  ...
  ├── QBt10-for-design/QPs4-for-design.md                 ← this page. No companion.
  └── unit.py
  ─────────────────────────────────────────────────────────────────────
...
```text
  ...
  ├── QBt10-for-design/QPs4-for-design.md
...
- 260806 CC · P1 ✅ and P2 ✅ are met by the two live companions, `../PaperSkillBoard-260725/QBt-page-types/_fixture-qbt/displays/QBt3-for-display/` and `QA-probe/QBt5-for-value/`. P3 ✅ is met by commit `dd7998ee`, which made `page_id()` fall back to a file's stem and let the drawer name be the binding.
