...
```text
🏷 QA-design/QA1-concepts/QA1-concepts.md · the QA is written twice, on purpose
...
`QA-design/QA1-concepts/QA1-concepts.md` repeats `QA`, and that repetition is doing work.
...
- 🧩 Skills · what this page governs, and whether it has landed there yet
  Full text of each unit is on its own skill page in the QCskill group, starting with `Design-1-haipipe-board`; this item only says what has landed.
