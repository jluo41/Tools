...
`QB8e` owns what happens once the records pile up, and `QE4` owns locks and two people writing at once.
...
- `QB-board/_archive/QB5a-evidence-card.md`
  Became `### 3` and `### 4`. Its design history stays here rather than being rewritten.
- `QB-board/_archive/QB5b-comments.md` · `QB-board/_archive/QB5c-editing.md`
  Became `### 5` and `### 6`.
