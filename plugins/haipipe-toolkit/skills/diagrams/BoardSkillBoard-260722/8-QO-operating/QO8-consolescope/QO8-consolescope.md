...
- [x] Implement the chosen shape
      Done 260724: `/boards` is a third top-level page (`main.tsx` routes on the pathname, `BoardsPage` = trio toggle + full-page BoardsView, no patient chrome); `../../../../../../platforms/HAIChat-SPACE/haichat-inlab/main.py` serves `/boards` for refreshes; `boards` removed from `ConsoleView`/`VIEW_META`/the Action page lists; the console topbar's scope toggle gained the third button `🧭 Boards`.
...
- `../../../../../../platforms/HAIChat-SPACE/haichat-inlab/web/src/components/BoardsView.tsx`
...
- `../../../../../../platforms/HAIChat-SPACE/haichat-inlab/web/src/Console.tsx`
  Only the topbar's third toggle button `🧭 Boards` is left here; it calls `navigate('boards')`.
- `../../../../../../platforms/HAIChat-SPACE/haichat-inlab/web/src/views.ts` · `../../../../../../platforms/HAIChat-SPACE/haichat-inlab/web/src/types.ts`
