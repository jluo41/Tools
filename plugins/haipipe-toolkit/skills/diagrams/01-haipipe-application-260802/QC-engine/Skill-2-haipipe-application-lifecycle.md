# haipipe-application-lifecycle · v0.4.4
state: 🔴 OPEN
owner: JL
method: three managed spans sync from the skill folder; everything else is written by hand

## Opening
haipipe-application-lifecycle is a shipped unit: what does it still owe, and is it healthy?
...
## Diagram
<!-- haipipe:skill:tree:start 98c47aed7e91abee application/1-lifecycle/haipipe-application-lifecycle -->

```
haipipe-application-lifecycle/
  CHANGELOG.md          54 ln  haipipe-application-lifecycle — Changelog
  SKILL.md             331 ln  Skill: haipipe-application-lifecycle (orchestrator)
```
...
## Content
<!-- haipipe:skill:body:start 98c47aed7e91abee application/1-lifecycle/haipipe-application-lifecycle -->

**haipipe-application-lifecycle** · `0.4.4` · last shipped 2026-07-19

- folder   `application/1-lifecycle/haipipe-application-lifecycle/`
...
## Log
260802 1200 · page generated from `application/1-lifecycle/haipipe-application-lifecycle/` by `skillpage.py new`

<!-- haipipe:skill:log:start 98c47aed7e91abee application/1-lifecycle/haipipe-application-lifecycle -->
...
260719 · `4.4.0`
      - Evidence Flow diagram synced to the current model: ① ORGANIZE writes a `## QX<n>` ENTRY with
        `### q-executor` / `### q-consumer` / `### bank binding` / `### a-executor`; ⑤ INTERPRET copies the QA
        answer into `### a-executor`, and each Q-consumer then writes its own a-consumer in the stage doc.
