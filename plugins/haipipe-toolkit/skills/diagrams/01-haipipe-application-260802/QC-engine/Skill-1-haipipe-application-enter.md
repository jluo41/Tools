# haipipe-application-enter · v0.2.3
state: 🔴 OPEN
owner: JL
method: three managed spans sync from the skill folder; everything else is written by hand

## Opening
haipipe-application-enter is a shipped unit: what does it still owe, and is it healthy?
...
## Diagram
<!-- haipipe:skill:tree:start 302c1d10e3b98bdb application/0-enter/haipipe-application-enter -->

```
haipipe-application-enter/
  feedback/
    2026-07-09_surface-releasable-probes.md    24 ln  "you should let me know what probes to release"
    README.md                            9 ln  haipipe-application-enter — Feedback Inbox
  CHANGELOG.md                          35 ln  haipipe-application-enter — Changelog
  SKILL.md                             401 ln  haipipe-application-enter (Intervention Console)
```
...
## Content
<!-- haipipe:skill:body:start 302c1d10e3b98bdb application/0-enter/haipipe-application-enter -->

**haipipe-application-enter** · `0.2.3` · last shipped 2026-07-19

- folder   `application/0-enter/haipipe-application-enter/`
...
- 1 · Missing path = get-or-create (the ONLY way interventions are created)
...
- 2 · Dashboard Contract (derive from disk)
...
- 7 · Legacy layout = offer the one-shot migration (confirm-gated)
...
```
feedback/2026-07-09_surface-releasable-probes.md    24 ln  "you should let me know what probes to release"
feedback/README.md                   9 ln  haipipe-application-enter — Feedback Inbox
```
...
## Log
260802 1200 · page generated from `application/0-enter/haipipe-application-enter/` by `skillpage.py new`

<!-- haipipe:skill:log:start 302c1d10e3b98bdb application/0-enter/haipipe-application-enter -->
