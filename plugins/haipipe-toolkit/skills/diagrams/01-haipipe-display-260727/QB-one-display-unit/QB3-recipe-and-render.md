...
## Boundary
- ✅ A recipe is Python, FigureSpec JSON, or a prompt plus renderer receipts.
- ✅ The recipe reads only declared Intake inputs for values.
- 🚫 A renderer does not look through task folders, recompute estimates, or select an arbitrary subset.
