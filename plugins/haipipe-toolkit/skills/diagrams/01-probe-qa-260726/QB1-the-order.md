...
The phase boundary is stated and unenforced: a DRAFT worker that planned probes would produce a valid-looking file, and the only reason it does not happen is that the workers were rewritten.
