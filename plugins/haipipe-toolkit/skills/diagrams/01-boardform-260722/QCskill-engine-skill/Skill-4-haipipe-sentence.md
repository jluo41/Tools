...
## Diagram
<!-- haipipe:skill:tree:start 73d23bea6996c812 board/haipipe-sentence -->

**What `haipipe-sentence` ships**: every file in the folder, with the one-line purpose each one states for itself.

```
haipipe-sentence/
  CHANGELOG.md          88 ln  haipipe-sentence · Changelog
  SKILL.md             191 ln  /haipipe-sentence · the sentence, as a contract you can load
```
...
## Content
<!-- haipipe:skill:body:start 73d23bea6996c812 board/haipipe-sentence -->

**haipipe-sentence** · `0.4.0` · last shipped 2026-08-09

- folder   `board/haipipe-sentence/`
- tools    not declared
- summary  Renamed from haipipe-board-sentence to haipipe-sentence (JL 260809), so the three altitudes read board, page, sentence; the contract itself is unchanged.
...
- 2 · 🚪 Three verbs, and this skill is the door for all of them
      ...
      ✎ EDIT       /haipipe-sentence edit "<the sentence>"
      🪪 CARD       /haipipe-sentence card on "<the words>"
      ```
...
<!-- haipipe:skill:log:start 73d23bea6996c812 board/haipipe-sentence -->
