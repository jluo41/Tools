# haipipe-page · v0.23.0
state: 🟡 in flux · door test passed 260802, scope bound unmeasured
owner: JL
method: three managed spans sync from the skill folder; everything else is written by hand

## Opening
`haipipe-page` is the spec one Board Page is measured against and the door for CREATE, WORK ON, and RUN.
...
`haipipe-page-for-skill` owns the Skill and Agent mirror kinds, and it is the variant this page itself is written to.

## Diagram
<!-- haipipe:skill:tree:start 68dc47f2fbb3a1e3 board/haipipe-page -->

**What `haipipe-page` ships**: every file in the folder, with the one-line purpose each one states for itself.

```
haipipe-page/
  ref/
    page-run-contract.md   195 ln  Page RUN contract
  CHANGELOG.md             333 ln  haipipe-page · Changelog
  SKILL.md                 477 ln  /haipipe-page · the page, as a contract you can load
```
...
## Content
<!-- haipipe:skill:body:start 68dc47f2fbb3a1e3 board/haipipe-page -->

**haipipe-page** · `0.23.0` · last shipped 2026-08-09

- folder   `board/haipipe-page/`
- tools    not declared
- summary  Page Type variants now ship under the page-types/ folder of the SKILL SET THAT OWNS THEM (JL 260809): five stay in board/, five moved to paper/, one is in subjective-label; eleven in total across three skill sets.
...
- 1 · 🧬 Page Types, one base
      ...
      **A variant ships under the `page-types/` folder of the SKILL SET THAT OWNS IT (JL 260809).**
      ...
      ELEVEN Page Type variants ship across three skill sets, and one of them must be loaded before you write the Page it governs:
      ```
      ...
      page-types/                                     stage of a paper or application
        ...
        needs          haipipe-page-for-meeting       Meeting-<n> · talk recorded here,
                       ...
                       haipipe-page-for-slide         one division per slide, each
                                                      embedding the deck LIVE via ?preview=N
      ...
      page-types/      haipipe-page-for-section       one reader-ordered unit, bound to
        the kinds                                     its venue allocation
        only a paper   haipipe-page-for-display       a unit a person must ACCEPT:
        has                                           figure, table, diagram
...
- 2 · 🎭 Four Page Phases, independent of Page Type
      ...
      ─────────────────────────────────────────────────────────────────────────────
      DRAFT       define or reopen purpose, Aims, promised shape page-phases/haipipe-page-draft
      PROBE       resolve a consequential unknown across the evidence wall
                                                               page-phases/haipipe-page-probe
      REVISE      improve the current promise while purpose and Aims stay fixed
                                                               page-phases/haipipe-page-revise
      CHECK       judge one version and route its next authority page-phases/haipipe-page-check
      ```
...
<!-- haipipe:skill:log:start 68dc47f2fbb3a1e3 board/haipipe-page -->

Converted from the skill's own `CHANGELOG.md`: 26 releases.
