...
- [ ] 🔁 Re-run after the page contract left SKILL.md (260806)
      ...
      Today that door is 0.124.0 and the page contract is a separate skill, `haipipe-page` 0.21.0, carrying Page = Type x Phase with ten Page Types under `board/page-types/`, four Page Phases under `board/page-phases/`, and the verbs CREATE, WORK ON and RUN.
