...
- ✅ P5 · The contract's embed rule matches what this page does, and its changelog names this page as the reason: `haipipe-board-page-for-slide/CHANGELOG.md` 0.4.0 records the re-ruling this page forced and names QA4 in its bullets, and 0.5.0 cites QA4 again. Two facts this row owes: the contract shipped 0.5.0 on 260806 while `## Files` still says 0.4.0, and 0.5.0 records that this deck's flat path `QA-design/slides/QA4-board-skillset-deck.html` predates its new companion-folder rule and does not follow it. Neither touches the embed rule P5 names.
...
- `../../board/page-types/haipipe-board-page-for-slide/SKILL.md`
  The for-slide contract this page tests, now 0.4.0; corrected here three times (live html embed at 0.2.0, beat strip at 0.3.0, per-slide accept rows at 0.4.0).
