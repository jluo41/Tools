...
```
📄 QB2a  the pages page list                     ◀ the page you have open
    │                                            ▸ ── the hidden chevron
    ├── 🧭 Opening        the lead, and this drawer
    ├── 🖼 Diagram        1 figure · no canvas
    ├── 📚 Content        3 divisions
...
## Glossary
- 🧱 **page list**: the fixed strip down the left side of every board page, listing the Index, the groups and the pages. Also called the page list; the two words mean the same thing on this page.
...
260801 · Page list drag handle hidden with the page list (it stood in the page as a bar when the page list was shut, JL screenshot) and moved from 80-matrix.css to 70-page list.css beside the page list it belongs to
