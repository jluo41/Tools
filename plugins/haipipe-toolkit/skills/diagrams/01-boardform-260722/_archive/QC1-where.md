...
/_excalidraw/?board=Tools/plugins/haipipe-toolkit/skills/diagrams/01-boardform-260722/fig/board.excalidraw&frame=QC1
...
## Log
260726 · promoted the delivery package from `skills/0_utils/haipipe-board/` to the first-class `skills/board/haipipe-board/`; the design Board stayed at `skills/diagrams/01-boardform-260722/`
