...
**The shape of this page is not this page's own** (260803). It comes from `../../board/page-types/haipipe-page-for-venue/SKILL.md`, whose reference implementation is `../QBv1-misq/QBv1-misq.md`, and a rule changed here is changed in that contract in the same pass:
...
- `../QBv8-npj-digital-medicine/QBv8-npj-digital-medicine.md` · the outlet this one pairs with
