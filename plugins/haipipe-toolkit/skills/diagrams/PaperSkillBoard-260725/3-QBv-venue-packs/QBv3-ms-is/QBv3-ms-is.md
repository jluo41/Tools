...
**The contract this page answers to** is `../../board/page-types/haipipe-page-for-venue/SKILL.md`, and its reference implementation is `../QBv1-misq/QBv1-misq.md`. Every rule in the block below belongs to that contract, not to this page, so a rule changed here is changed there in the same pass.
