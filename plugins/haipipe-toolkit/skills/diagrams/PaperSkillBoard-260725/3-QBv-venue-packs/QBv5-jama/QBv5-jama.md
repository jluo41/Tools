...
**The shape of this page is a contract, not a local habit** (JL 260803). It is `../../board/page-types/haipipe-page-for-venue/SKILL.md`, and `../QBv1-misq/QBv1-misq.md` is its reference implementation. A rule changed here is changed in that file in the same pass.
...
- `../QBv7-jama-network-open/QBv7-jama-network-open.md` · the outlet whose exemplars are in this folder
