...
- `../QBv8-npj-digital-medicine/QBv8-npj-digital-medicine.md` · where a dataset-only paper goes when the claim becomes clinical
- `../QBv1-misq/QBv1-misq.md` · the desk that refuses outright what this one accepts
