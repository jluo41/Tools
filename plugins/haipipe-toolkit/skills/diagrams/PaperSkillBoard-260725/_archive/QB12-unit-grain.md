...
- ↪ Covered elsewhere
  What that artifact IS is `QB9`; what it is called is `QB10`.
...
A gate is one human saying yes to one specific thing (`QB8`). So the grain of the artifact and the grain of the gate have to match, or the gate becomes unanswerable.
