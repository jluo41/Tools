...
**Where the candidates live**: `4-QBt-page-types/QBt16-display-construction/display/QBt16-display-construction/candidates/`, generated together by one script from one bank output.

**Covered elsewhere**: `../QBt3-for-display/QBt3-for-display.md` owns acceptance of a selected render; `../QBt5-for-value/QBt5-for-value.md` owns the Value binding and bank provenance.
...
![](4-QBt-page-types/QBt16-display-construction/display/QBt16-display-construction/candidates/A-ranked-bars.png)

📊 Candidate A makes the distribution and the zero-path contracts visible with the least decoding.

artifact: `4-QBt-page-types/QBt16-display-construction/display/QBt16-display-construction/candidates/A-ranked-bars.png`
...
![](4-QBt-page-types/QBt16-display-construction/display/QBt16-display-construction/candidates/B-paths-vs-lines.png)

🔬 Candidate B tests whether path naming merely follows contract length while preserving each contract as a labelled point.

artifact: `4-QBt-page-types/QBt16-display-construction/display/QBt16-display-construction/candidates/B-paths-vs-lines.png`
...
![](4-QBt-page-types/QBt16-display-construction/display/QBt16-display-construction/candidates/C-audit-table.png)

📋 Candidate C preserves exact values and source order but asks the reader to perform the comparison.

artifact: `4-QBt-page-types/QBt16-display-construction/display/QBt16-display-construction/candidates/C-audit-table.png`
...
- `4-QBt-page-types/QBt16-display-construction/display/QBt16-display-construction/input/proof-packet.md`
  Read the fixed proof question, bank path, scope, and claim ceiling before judging a candidate.
- `4-QBt-page-types/QBt16-display-construction/display/QBt16-display-construction/source/build.py`
