...
**Where this page sits**: `QA1@display` settles which LAYER owns which part of a display, and QBe2a settles which half of a unit ships.
...
**Keep owning and triggering apart**: `QA1@display` answers who owns which part and QBe2a answers which half ships.
...
- `QBe2a-display-folder.md` · which half of a unit ships, which this page must not re-decide
...
260803 · Left `QB · Delivery` for the new `QBe · Delivery Element` group, and `QB13b` became `QBe2b`, then took its place in the unit-size order ruled the same day (JL 260803: sentence, display, section); the old id resolves as a declared alias in `board.md ## Links`.
