...
state: ⚫ RETIRED 260805 · page logic in board/page-phases/haipipe-board-page-revise; craft in paper/S06-main/section-edit/
owner: JL
method: three managed spans sync from the skill folder; everything else is written by hand

**Retired 260805 (thin-paper phase 2, QC6).** The REVISE worker split the same way as DRAFT: the page logic lives on in `board/page-phases/haipipe-board-page-revise`, and the revision craft became the stage data files `paper/S06-main/section-edit/revise-place-craft.md` and `paper/S06-main/section-edit/revise-results-craft.md`, loaded through the stage.md `craft:` list. The worker folders retired to `paper/_old/workers/`. The account below is the pre-fold record and stays as written.
...
## Log
- 260806 0130 · [REVISE-CC] retirement recorded: board/page-phases/haipipe-board-page-revise + S06-main/section-edit/revise-place-craft.md and revise-results-craft.md
