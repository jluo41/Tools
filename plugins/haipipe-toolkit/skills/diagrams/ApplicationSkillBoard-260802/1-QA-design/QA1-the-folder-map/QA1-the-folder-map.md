...
**Where this page sits**: The precedent is `QA1@paper`, the same face on the paper family's board at `../PaperSkillBoard-260725/1-QA-design/QA1-the-folder-map/QA1-the-folder-map.md`.
...
```text
 🧩 THE THING                       📋 ITS BOARD
 🛠 skills/application/         ⟷   📌 ApplicationSkillBoard-260802 · here
...
- `../PaperSkillBoard-260725/1-QA-design/QA1-the-folder-map/QA1-the-folder-map.md`
