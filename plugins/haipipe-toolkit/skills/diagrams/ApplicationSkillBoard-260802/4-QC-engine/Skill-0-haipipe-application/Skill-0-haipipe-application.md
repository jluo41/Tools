# haipipe-application · v0.8.0
state: 🟡 PARTIAL · v0.8.0 synced · fresh-context proof pending
owner: JL
method: three managed spans sync from the skill folder; everything else is written by hand

## Opening
Does the public Application door now express the intended Brief → local Insights
→ many Designs → optional Artifacts system?

Version 0.8.0 owns the four Page routes and the new runtime folder. This Page is
healthy when its managed snapshot stays current, structural validation passes,
and a fresh agent follows the missing-insight and Artifact-promotion boundaries.

### Writing Style

Describe current routing in user-facing Page terms. Keep generated inventory
separate from the human judgment about whether the route works.

## Diagram
<!-- haipipe:skill:tree:start ffce83cba8bccc4c application/haipipe-application -->

**What `haipipe-application` ships**: every file in the folder, with the one-line purpose each one states for itself.
...
haipipe-application/
  ...
  fn/
    artifact.md           11 ln  `artifact` · project or promote one delivery unit
    brief.md              11 ln  `brief` · create or resume the Application Brief
    ...
    insight.md            11 ln  `insight` · create or resume one Application-local Insight Page
    intervention.md       11 ln  `intervention` / `design` · create or resume one audience/job Design Page
    missing-insight.md    13 ln  `missing-insight` · release a blocked need to a local Insight Page
    probes.md             15 ln  `probes` · route evidence acquisition through an Application Insight Page
  ref/
    render-deck.py       487 ln  Convert a markdown chunk to inline HTML via pandoc (no wrapper).
  CHANGELOG.md           360 ln  haipipe-application — Changelog
  PREFERENCES.md          25 ln  haipipe-application — Behavioral Preferences (portable)
  SKILL.md               202 ln  /haipipe-application · understand for this application, then design
...
```text
intent → Application 0.8.0 → Brief | Insight | Design | Artifact
                                  │       │        │
                                  └──── shared Page workflow ────┘
```

## Content
<!-- haipipe:skill:body:start ffce83cba8bccc4c application/haipipe-application -->

**haipipe-application** · `0.8.0` · last shipped 2026-08-20
...
13 files besides `SKILL.md` and `CHANGELOG.md`, each with the purpose it states about itself. They are described here, not reproduced: the folder is the copy.

```
PREFERENCES.md             25 ln  haipipe-application — Behavioral Preferences (portable)
agents/openai.yaml          4 ln
feedback/README.md         63 ln  haipipe-application — Feedback Inbox (orchestrator fallback)
fn/artifact.md             11 ln  `artifact` · project or promote one delivery unit
fn/brief.md                11 ln  `brief` · create or resume the Application Brief
...
fn/insight.md              11 ln  `insight` · create or resume one Application-local Insight Page
fn/intervention.md         11 ln  `intervention` / `design` · create or resume one audience/job Design Page
fn/missing-insight.md      13 ln  `missing-insight` · release a blocked need to a local Insight Page
fn/probes.md               15 ln  `probes` · route evidence acquisition through an Application Insight Page
...
<!-- haipipe:skill:log:start ffce83cba8bccc4c application/haipipe-application -->
