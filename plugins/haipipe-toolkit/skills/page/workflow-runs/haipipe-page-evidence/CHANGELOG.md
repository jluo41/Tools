...
- Route CITE Evidence Item work to `haipipe-workbench-evidence`, which now owns
...
- **EVIDENCE stated as TWO stages, MAKE then BIND**, both inside the workbench
...
- §🪪 corrected: `PROBE` is a LIVE phase again and is NOT this one. The alias
  ...
  `65-workbench-pageflow.js` now resolves the token.
