...
`haipipe-workbench-page/ref/plan-grammar.md`, applicable policy and the
...
human acceptance; this Run owns the adopted Page and delivery trace.
...
```bash
python3 <haipipe-page-writing>/cli/promote_paragraph.py --page <page>.md --result <resolved-result> --dry-run
