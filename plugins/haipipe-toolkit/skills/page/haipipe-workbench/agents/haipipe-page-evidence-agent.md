...
tools:
  ...
  - Skill
model: inherit
# Effort tier per Run (page-run-contract.md, JL 260820): the middle Runs
...
with one binding the packet can never override: `run` is evidence, always,
...
**Load:** read the ⚡ Run card at the top of `haipipe-page-evidence` FIRST,
...
`haipipe-page-workflow/ref/page-run-contract.md`, `actor: haipipe-page-evidence-agent`, `cycle: LAND | EMBED`.
