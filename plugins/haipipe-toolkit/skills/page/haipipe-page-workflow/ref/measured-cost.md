...
> Read-only measurements from 260819-20. Retired Run names below are not
...
Runs are expensive, and why.

## The measurements

```text
Run                      what it did                       min    ktok  tools  s/tool
────────────────────────────────────────────────────────────────────────────────────────
...
the longest Run because it made 152 of those calls, not because it thought
...
units inline pays the full sum, which is what happened on QC2 when the Run
...
minutes on top of the Run that found it. That is not overhead to remove; it
