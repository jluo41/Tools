...
- Review: <the exact fixed scope and its applicable Structure descriptions>
...
- Target: <C.P.B / paragraph / Section>
...
copying unrelated inventories. Include the changed Outline headings if the structure changed; else
...
Each paragraph heading must use the description frozen by the closed
Structure Run. Resolve it from the Page-local `P01..PN` index in the Outline;
do not infer a replacement from the candidate prose.
