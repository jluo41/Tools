...
This Page explains how to create and revise that workspace, how its workbenches use the same files, and how Board can organize it without owning its content.
...
### 2 · Board and workbenches

**Division map**: Board navigation and workbench workspaces share the Page's sources.
...
Workbenches present the Page's planning records, conversations, runs, outputs, and files through their own declared writers. <!-- realizes: C2.P2.B2 -->
A workbench is not enabled merely because a folder or a button bears its name; its surface must reach the real records and supported actions. <!-- realizes: C2.P2.B3 -->
