...
- `../../../../board/haipipe-board/live/chat.py` · the GUI form: sessions, the SDK turn,
  `prime_context`, the compact rules text that points here, the tiers
- `../../../../board/haipipe-board/live/term.py` · the TUI form: the PTY, parking,
  reattachment
- `../../../../board/haipipe-board/live/write.py` · the pens the drawer calls: comment,
  edit-sentence, discuss (a `D<nn>` record into `outline/<stem>-discussion.md`)
- `../../../../board/haipipe-board/cli/serve.py` · `/_board/chat`, `/_board/chat-keep`
