---
name: haipipe-workbench-studio
description: >-
  The ONE presentation workbench for a page's studio: a single 🎨 Studio tab
  ...
  workbench, studio tab, chat, page chat, keep this session, draw, Excalidraw,
...
# /haipipe-workbench-studio · one room, two tools, one tab

**LOAD `haipipe-workbench` FIRST.** A CATEGORY workbench (haipipe-workbench §🔌):
...
`servers/haipipe-board/shell.py`: tab id `studio`, the paired stage, the folded 💬/🖌/🎞
...
- `../haipipe-workbench/ref/roster.md` · the studio/ category row
- `../../../servers/haipipe-board/shell.py` · the tab, the split, the migration
