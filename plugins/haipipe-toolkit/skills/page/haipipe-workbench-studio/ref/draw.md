...
> 🎨 Since 260831 evening this editor is the UPPER half of the one 🎨 Studio tab (`haipipe-workbench-studio`), staged above the live chat with its ✨ bar; ownership, the autodraw hand-drawn refusal and the chat pen are unchanged — only where the canvas hangs moved.
