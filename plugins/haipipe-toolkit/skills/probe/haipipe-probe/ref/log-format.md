...
Owner:    Auto-appended by probe skills + manually edited by user/Claude.
...
proposed          explore suggested next steps from this probe
...
Difference from project's defunct runlogs/
---------------------------------------------

```
project/runlogs/<DATE>-runlog.md     (DELETED 2026-05-24)
  was: per-task daily index + LLM narrative of runs
  why deleted: "today's runs" wasn't a real research question

probe/<probe>/logs/<DATE>.md    (THIS file)
