...
work that a legacy outbound card already authorized. New typed Evidence Items
normally use Discovery/Execution Supporting Runs directly.
...
3. Do not re-decide the selected Run action; SURVEY already did.
