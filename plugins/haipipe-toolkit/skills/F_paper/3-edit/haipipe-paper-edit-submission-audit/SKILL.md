---
name: haipipe-paper-edit-submission-audit
...
metadata:
  ...
  changelog:
    - "1.1.0 (2026-06-05): renamed from submission-audit to haipipe-paper-edit-submission-audit; consolidated into 3-edit/ (haipipe-paper-* name unification)."
...
```bash
python ~/.codex/skills/haipipe-paper-edit-submission-audit/scripts/check_figure_refs.py path/to/manuscript.md
```
...
- Heavy structural rewrites that belong in `haipipe-paper-edit-optimizer`
