...
|-------|------|-------------|
| `haipipe-paper-edit` (orchestrator) | `skills/F_paper/3-edit/haipipe-paper-edit/SKILL.md` | ✅ on next reload (valid `name:`) |
| `haipipe-paper-edit-content` + 5 topic stubs | `skills/F_paper/3-edit/paper-edit-*/SKILL.md` | ✅ on next reload |
| 4 stage agents | `skills/F_paper/3-edit/agents/*.md` | ⚠️ **not** as `subagent_type` (nested, not in top-level `agents/`) |
...
for a in format-checker annotator improver cleaner; do
  ln -s ../skills/F_paper/3-edit/agents/paper-edit-$a.md paper-edit-$a.md
done
```
