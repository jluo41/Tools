---
name: haipipe-paper-structure-diagram
...
metadata:
  ...
  changelog:
    - "1.1.0 (2026-06-05): renamed from paper-structure-diagram to haipipe-paper-structure-diagram (haipipe-paper-* name unification)."
    - "1.0.0 (2026-05-31): baseline metadata added."
---

# /haipipe-paper-structure-diagram — Section / Paragraph / Sentence Maps
...
## When to Defer
- Want figures inside the paper rendered → use `/haipipe-paper-structure-figure`
...
```
/haipipe-paper-structure-diagram                              section view of paper at cwd
/haipipe-paper-structure-diagram sections [path]              section view (whole paper)
/haipipe-paper-structure-diagram paragraphs <sec> [path]      paragraph view of one section
/haipipe-paper-structure-diagram sentences <sec> <par> [path] sentence view of one paragraph
/haipipe-paper-structure-diagram all [path]                   all three for whole paper
```
...
Compatible with both `haipipe-paper-structure-bootstrap` layout and the user's `0-` prefix convention:
...
7. **Append** a one-line "next action" hint when something is flagged:
   ...
   - `→ §1 ¶3 has no [claim]. Run /haipipe-paper-structure-diagram sentences 1 3 to inspect.`

---

## Cross-references

- `haipipe-paper-structure-bootstrap` (`05_prewrite/`) — initial folder layout this skill reads.
- `paper-revise` (`07_revise/`) — interactive section/paragraph revision; pair with this to pick *what* to revise next.
- `haipipe-paper-edit-optimizer` (`07_revise/`) — structural revision pass; this skill is its visual companion.
- `haipipe-paper-structure-architecture` (deprecated) — see this skill instead for paper-shaped structure views.
