...
description: "Generate a concise strategic architecture overview for an academic paper (150-300 lines, Markdown or LaTeX): one-paragraph contribution, key metrics, three contributions with emphasis percentages, 5-act story arc, framing guidance, scope boundaries, venue positioning. Trigger: paper architecture, architecture overview, strategic blueprint, 论文架构, /haipipe-paper-structure-architecture."
...
```
/haipipe-paper-structure-architecture @00-incubator-paper.tex
→ Outputs LaTeX format

/haipipe-paper-structure-architecture @paper-structure.md
→ Outputs Markdown format
```

### With Additional Context:
```
/haipipe-paper-structure-architecture @00-incubator-paper.tex @slides.pdf
...
```
/haipipe-paper-structure-architecture @paper.tex --format markdown
→ Forces Markdown output despite .tex input

/haipipe-paper-structure-architecture @paper.md --format latex
...
**Examples:**
- `/haipipe-paper-structure-architecture @00-incubator-paper.tex` → Outputs LaTeX
- `/haipipe-paper-structure-architecture @paper-structure.md` → Outputs Markdown
- `/haipipe-paper-structure-architecture @slides.pdf @paper.tex` → Outputs LaTeX (first recognized format file)
- `/haipipe-paper-structure-architecture --format markdown @paper.tex` → Outputs Markdown (explicit override)
...
**Automatic Format Detection:** When you invoke `/haipipe-paper-structure-architecture @00-incubator-paper.tex`, the skill automatically detects the `.tex` extension and generates LaTeX output. No need to specify `--format latex`.
...
- Use: `/haipipe-paper-structure-architecture --convert-to latex @existing-overview.md`

**LaTeX → Markdown:**
- Can be done automatically if user requests format change
- Use: `/haipipe-paper-structure-architecture --convert-to markdown @existing-overview.tex`
