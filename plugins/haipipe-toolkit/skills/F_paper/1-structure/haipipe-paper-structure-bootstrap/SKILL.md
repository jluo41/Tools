...
metadata:
  ...
  changelog:
    - "1.1.0 (2026-06-05): renamed from paper-bootstrap to haipipe-paper-structure-bootstrap (haipipe-paper-* name unification)."
...
```bash
python ~/.codex/skills/haipipe-paper-structure-bootstrap/scripts/init_paper_layout.py /data/boom/Papers/<paper>
```
