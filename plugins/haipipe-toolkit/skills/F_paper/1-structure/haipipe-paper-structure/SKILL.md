...
needs rethinking. This is the **Plan cycle (①)** in the F_paper mental
model (see `F_paper/MENTAL_MODEL.md`).
...
haipipe-paper-structure-narrative     CONTRACT:  generate NARRATIVE_REPORT.md from research
                                                 ...
                                                 limitations. Entry gate from upstream E_insight.
```
...
F_paper mental model — the hand-off goes to `2-build/` and `3-edit/`
skills.
...
`haipipe-paper` (in `F_paper/0-workflow/`) is the top-level paper
