...
|-------|-----------|---------|
| ① content | `paper-edit-content` | structure, one-point paragraphs, claims, flow |
| ② values | `paper-edit-values` | numbers vs `0-display/` source |
| ③ citations | `paper-edit-citation` | `\cite` resolves / real / on-claim |
| ④ consistency | `paper-edit-consistency` | terms, notation, `\label`/`\ref` |
| ⑤ format | `paper-edit-format` | venue style, units, abbreviations |
| ⑥ typeset | `paper-edit-typeset` | widows, orphans, overfull boxes |
...
> Only `paper-edit-content` is fully written today; the other five topics are
...
| Heavy sentence surgery / logic rewrite | finer annotate→improve rounds in `paper-edit` (legacy `paper-revise` archived in `_archive/`) |
