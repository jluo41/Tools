...
Skill: haipipe-paper-build-scaffold (2-build)
================================

Create a **new** paper folder that conforms to `2-build/_shared/paper-folder-anatomy.md`. This skill writes structure only: drivers, wrappers, leaf stubs, directories, the compile script. It never writes a body sentence; prose belongs to `3-write` / `haipipe-paper-create`.
...
/haipipe-paper-build-scaffold 1-structure/NARRATIVE_REPORT.md            (asks for out dir + venue)
...
Banner ids follow `3-edit/_shared/paragraph-indexing.md` (`<section-slug>.<para-slug>`, stable, never renumbered). Scaffolding them now means the create/edit stages inherit stable handles for free.
