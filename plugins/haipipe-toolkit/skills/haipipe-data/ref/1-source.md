...
2. **Respect the golden rule**: output of Layer 1 = input of Layer 2 (Record)
3. **Maintain schema consistency** per domain -- all SourceFns for a domain
