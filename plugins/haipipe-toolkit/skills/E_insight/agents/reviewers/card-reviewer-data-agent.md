...
metadata:
  ...
  summary: "REVIEWER agent for E_insight 🟦 D (data) cards."
  changelog:
...
D_probe's job upstream; I judge the CARD.
...
- judge whether the underlying claim is TRUE → `D_probe` `review` (upstream)
