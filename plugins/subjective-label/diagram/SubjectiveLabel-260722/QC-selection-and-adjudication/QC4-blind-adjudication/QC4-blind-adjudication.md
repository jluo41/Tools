...
- `reads · ALL` · [QC3 §4](QC-selection-and-adjudication/QC3-compose-human-batch/QC3-compose-human-batch.md)
  QC3 supplies the frozen B_t membership and item roles.
- `continues · ALL` · [QB3 page](QB-calibration-round/QB3-checkpoint-and-versions/QB3-checkpoint-and-versions.md)
