...
- `constrained by · ALL` · [QA0 §16](QA-semantic-contract/QA0-the-revised-conception/QA0-the-revised-conception.md)
  QA0 defines the candidate funnel and broad-pool boundary.
- `continues · ALL` · [QC2 §1](QC-selection-and-adjudication/QC2-prelabel-and-seal/QC2-prelabel-and-seal.md)
