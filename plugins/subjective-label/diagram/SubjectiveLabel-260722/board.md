...
QA1-coldstart QB-calibration-round/QB1-initialize-round-one/QB1-initialize-round-one.md
QA2-split-label QC-selection-and-adjudication/QC3-compose-human-batch/QC3-compose-human-batch.md
QA3-weak-exam QE-final-evaluation-and-completion/QE2-model-scorecard/QE2-model-scorecard.md
QB1-grow-140 QC-selection-and-adjudication/QC1-candidate-pool/QC1-candidate-pool.md
QB2-layered-eval QD-optimization-and-convergence/QD2-round-metrics/QD2-round-metrics.md
QB3-external-license QE-final-evaluation-and-completion/QE2-model-scorecard/QE2-model-scorecard.md
QC1-when-stop QD-optimization-and-convergence/QD4-stopping-criteria/QD4-stopping-criteria.md
QC2-scale-out QE-final-evaluation-and-completion/QE3-complete-corpus/QE3-complete-corpus.md
QC3-objective QA-semantic-contract/QA1-system-contract/QA1-system-contract.md
QD1-embedding QB-calibration-round/QB1-initialize-round-one/QB1-initialize-round-one.md
QD2-cascade QE-final-evaluation-and-completion/QE3-complete-corpus/QE3-complete-corpus.md
QD3-train-classifier QC-selection-and-adjudication/QC1-candidate-pool/QC1-candidate-pool.md
QD4-auto-lexicon QA-semantic-contract/QA3-guideline-contract/QA3-guideline-contract.md
