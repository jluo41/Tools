...
- `constrained by · ALL` · [QA0 §11](QA-semantic-contract/QA0-the-revised-conception.md)
  Use the approved names and lifecycle for C_t, B_t, P_t, Y*_t, D_t, and closed guideline states.
- `constrained by · ALL` · [QA0 §12](QA-semantic-contract/QA0-the-revised-conception.md)
  Preserve the distinction between a Calibration Round, its Human-AI Sessions, and its Checkpoint.
- `continues · ALL` · [QA0 §15](QA-semantic-contract/QA0-the-revised-conception.md)
