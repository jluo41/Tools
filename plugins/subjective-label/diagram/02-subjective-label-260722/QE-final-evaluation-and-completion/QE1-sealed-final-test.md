...
- `constrained by · ALL` · [QB1 §2](QB-calibration-round/QB1-initialize-round-one.md)
  QB1 reserves the initial sealed identifiers.
- `reads · ALL` · [QD4 §4](QD-optimization-and-convergence/QD4-stopping-criteria.md)
  QD4 supplies the G* freeze decision.
- `continues · ALL` · [QE2 page](QE-final-evaluation-and-completion/QE2-model-scorecard.md)
