...
- `reads · ALL` · [QE2 §4](QE-final-evaluation-and-completion/QE2-model-scorecard.md)
  QE2 supplies eligible executor evidence and failure strata.
- `continues · ALL` · [QE4 page](QE-final-evaluation-and-completion/QE4-final-audit-and-provenance.md)
