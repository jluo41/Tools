...
- `constrained by · ALL` · [QA0 §3](QA-semantic-contract/QA0-the-revised-conception.md)
  QA0 §3 supplies the approved input conception for the six-entry roster.
- `constrained by · ALL` · [QA0 §4](QA-semantic-contract/QA0-the-revised-conception.md)
  QA0 §4 supplies the approved meanings of the final deliverables.
- `constrained by · ALL` · [QA0 §5](QA-semantic-contract/QA0-the-revised-conception.md)
  QA0 §5 supplies the one-human semantic authority boundary.
- `constrained by · ALL` · [QA0 §19](QA-semantic-contract/QA0-the-revised-conception.md)
  QA0 §19 supplies the distinction between model disagreement, consensus, and diagnostic evidence.
- `constrained by · ALL` · [QA0 §28](QA-semantic-contract/QA0-the-revised-conception.md)
  QA0 §28 supplies the provenance tiers and reliability claims.
- `constrained by · ALL` · [QA0 §30](QA-semantic-contract/QA0-the-revised-conception.md)
