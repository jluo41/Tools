...
- `reads · ALL` · [QD2 §2](QD-optimization-and-convergence/QD2-round-metrics.md)
  QD2 supplies the comparable quality series.
- `reads · ALL` · [QD3 page](QD-optimization-and-convergence/QD3-coverage-and-stability.md)
  QD3 supplies coverage, stability, and risk evidence.
- `continues · ALL` · [QE1 page](QE-final-evaluation-and-completion/QE1-sealed-final-test.md)
