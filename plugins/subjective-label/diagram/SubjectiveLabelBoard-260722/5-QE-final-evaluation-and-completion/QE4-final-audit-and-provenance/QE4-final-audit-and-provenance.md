...
- `reads · ALL` · [QE3 §4](5-QE-final-evaluation-and-completion/QE3-complete-corpus/QE3-complete-corpus.md)
  QE3 supplies terminal production records and route provenance.
- `constrained by · ALL` · [QA1 §2](1-QA-semantic-contract/QA1-system-contract/QA1-system-contract.md)
  QA1 defines the final output and authority contract.
- `continues · ALL` · [QF2 page](6-QF-execution-contract/QF2-artifact-schema-config/QF2-artifact-schema-config.md)
