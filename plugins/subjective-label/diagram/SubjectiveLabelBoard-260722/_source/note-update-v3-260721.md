...
- `examples-nlp/Project-Subjective-Label/discoveries/b03_external_validation_datasets/j01_external_validation_datasets_inquiry/` — battery audit
- `examples-nlp/Project-Subjective-Label/tasks/B02_dim_openness/` — junjie's base-rate scaffold (to generalize)
- `examples-nlp/Project-Subjective-Label/tasks/B03_dim_openness/` — full-run engine instance (κ inflated by non-representative anchor)
