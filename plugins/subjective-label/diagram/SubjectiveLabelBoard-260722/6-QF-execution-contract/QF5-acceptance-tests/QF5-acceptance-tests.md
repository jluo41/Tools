...
#### 1.2 · Skill checks
Every canonical and compatibility skill passes the skill-creator's `quick_validate.py`, which is installed per machine and lives outside this repository, or the repository's equivalent validation.
...
- `../../../haipipe-toolkit/skills/board/haipipe-board/cli/check.py`
...
- `reads · ALL` · [QF4 page](6-QF-execution-contract/QF4-library-mapping/QF4-library-mapping.md)
