...
- `constrained by · ALL` · [QF1 page](6-QF-execution-contract/QF1-skill-command-contract/QF1-skill-command-contract.md)
  QF1 prevents commands from claiming unimplemented automation.
- `constrained by · ALL` · [QF2 page](6-QF-execution-contract/QF2-artifact-schema-config/QF2-artifact-schema-config.md)
