...
- `reads · ALL` · [QC1 §4](3-QC-selection-and-adjudication/QC1-candidate-pool/QC1-candidate-pool.md)
  QC1 supplies the versioned C_t manifest.
- `continues · ALL` · [QC3 page](3-QC-selection-and-adjudication/QC3-compose-human-batch/QC3-compose-human-batch.md)
