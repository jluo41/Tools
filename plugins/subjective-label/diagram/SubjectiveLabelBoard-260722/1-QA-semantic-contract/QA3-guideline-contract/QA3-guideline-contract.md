...
- `constrained by · ALL` · [QA0 §6](1-QA-semantic-contract/QA0-the-revised-conception/QA0-the-revised-conception.md)
  Preserve QA0's separation of class, diagnostic region, and uncertainty.
- `constrained by · ALL` · [QA0 §9](1-QA-semantic-contract/QA0-the-revised-conception/QA0-the-revised-conception.md)
  Preserve QA0's five-part annotation policy and human-authority boundary.
- `constrained by · ALL` · [QA0 §15](1-QA-semantic-contract/QA0-the-revised-conception/QA0-the-revised-conception.md)
  Preserve QA0's checkpoint freeze, regression, and impact-review rules.
- `constrained by · ALL` · [QA0 §21](1-QA-semantic-contract/QA0-the-revised-conception/QA0-the-revised-conception.md)
  Preserve QA0's separation between the core policy and model-specific execution wrapper.
- `constrained by · ALL` · [QA0 §22](1-QA-semantic-contract/QA0-the-revised-conception/QA0-the-revised-conception.md)
