---
name: label-status
description: "Read-only dashboard for a human-grounded subjective-labeling project. Shows lifecycle phase, open round, D_t/G_t, Session progress, audit and challenge evidence, seven-region coverage, stopping gates, sealed-test validity, executor scorecards, production provenance, implementation holds, and next valid action. Use for /label-status or progress checks."
---
