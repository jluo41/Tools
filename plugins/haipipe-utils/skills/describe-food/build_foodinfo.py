...
BENCH = ROOT / "examples/Proj01-CGM-RawData/tasks/_legacy/v0-task-groups/AY1_foodrec_v1/00_benchmark"
...
def main():
    ...
    rep = write(
        ...
        sections=[
            ...
            "`examples/Proj01-CGM-RawData/tasks/_legacy/v0-task-groups/AY1_foodrec_v1/00_benchmark/`.",
        ])
