...
See [shared-references/output-versioning.md](../skills/00_meta/shared-references/output-versioning.md) for the full protocol.
...
See [shared-references/output-manifest.md](../skills/00_meta/shared-references/output-manifest.md) for the full protocol.
