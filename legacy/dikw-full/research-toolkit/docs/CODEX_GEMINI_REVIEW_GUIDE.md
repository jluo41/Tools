...
This guide is **additive** to the upstream Codex-native path. It does not replace `skills/00_meta/skills-codex/`.

## Architecture

- Base skill set: `skills/00_meta/skills-codex/`
- Reviewer override layer: `skills/00_meta/skills-codex-gemini-review/`
- Reviewer bridge: `mcp-servers/gemini-review/`

The install order matters:

1. install `skills/00_meta/skills-codex/*`
2. install `skills/00_meta/skills-codex-gemini-review/*`
...
cp -a skills/00_meta/skills-codex/* ~/.codex/skills/
cp -a skills/00_meta/skills-codex-gemini-review/* ~/.codex/skills/
...
- **Full overlay coverage check**: all `15` predefined reviewer-aware Codex skills overridden by `skills/00_meta/skills-codex-gemini-review/` were checked to confirm they point at `gemini-review` and no longer depend on the old reviewer transport.
...
Everything else still comes from the upstream `skills/00_meta/skills-codex/` package.
...
- reuse `skills/00_meta/skills-codex/*` unchanged
- only override the reviewer-aware skills in `skills/00_meta/skills-codex-gemini-review/*`
