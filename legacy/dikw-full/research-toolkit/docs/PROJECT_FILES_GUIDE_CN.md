...
详见 [shared-references/output-versioning.md](../skills/00_meta/shared-references/output-versioning.md)。
...
详见 [shared-references/output-manifest.md](../skills/00_meta/shared-references/output-manifest.md)。
