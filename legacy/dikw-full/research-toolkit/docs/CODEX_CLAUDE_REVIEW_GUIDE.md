...
- Reviewer override layer: `skills/00_meta/skills-codex-claude-review/`
- Reviewer bridge: `mcp-servers/claude-review/`

The install order matters:

1. install `skills/00_meta/skills-codex/*`
2. install `skills/00_meta/skills-codex-claude-review/*`
...
cp -a skills/00_meta/skills-codex-claude-review/* ~/.codex/skills/
