...
这条路径是对上游 Codex 原生方案的**增量叠加**，不会替代 `skills/00_meta/skills-codex/`。

## 架构

- 基础技能包：`skills/00_meta/skills-codex/`
- 审稿覆盖层：`skills/00_meta/skills-codex-claude-review/`
- 审稿 bridge：`mcp-servers/claude-review/`

安装顺序必须保持：

1. 先安装 `skills/00_meta/skills-codex/*`
2. 再安装 `skills/00_meta/skills-codex-claude-review/*`
...
其余技能仍然来自上游原生 `skills/00_meta/skills-codex/`。
